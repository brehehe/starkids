<div class="min-h-screen bg-gradient-to-br from-blue-50 to-green-50">
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800"><?php echo e($company->name ?? 'Klinik Sehat Mandiri'); ?></h1>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer branch-card"
                            ...
                            onclick="selectBranch(<?php echo e($branch['id']); ?>, '<?php echo e($branch['name']); ?>')">
                            <div class="relative h-48 bg-gradient-to-br from-blue-500 to-green-500">
                                <img src="<?php echo e($branch['image'] ?? asset('img/clinic-branch.jpg')); ?>"
                                    alt="<?php echo e($branch['name']); ?>" class="w-full h-full object-cover mix-blend-overlay">
                                ...
                                <div class="absolute bottom-4 left-4 text-white">
                                    ...
                                    <p class="text-sm opacity-90">
                                        <i class="fas fa-map-marker-alt mr-1"></i><?php echo e($branch['city']); ?>
                            ...
                            <div class="p-6">
                                <div class="mb-4">
                                    ...
                                    <p class="text-gray-600 text-sm mb-4">
                                        ...
                                        <?php echo e($branch['hours'] ?? 'Senin - Sabtu: 08:00 - 20:00'); ?>
                                ...
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <div class="font-semibold text-blue-600"><?php echo e($branch['distance'] ?? '2.5 km'); ?>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="max-w-4xl mx-auto">
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $polies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $poly): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="bg-gradient-to-br from-blue-50 to-green-50 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer poly-card"
                            data-poly-id="<?php echo e($poly['id']); ?>"
                            onclick="selectPoly(<?php echo e($poly['id']); ?>, '<?php echo e($poly['name']); ?>')">
                            <div class="p-6 text-center">
                                <div
                                    ...
                                    <i class="<?php echo e($poly['icon']); ?> text-white text-2xl"></i>
                                </div>
                                <h3 class="text-xl font-semibold text-gray-800 mb-3"><?php echo e($poly['name']); ?></h3>
                                <p class="text-gray-600 text-sm mb-4"><?php echo e($poly['description']); ?></p>
                                <div class="flex items-center justify-between text-sm">
                                    <span class="text-green-600 font-semibold">
                                        <i class="fas fa-user-md mr-1"></i><?php echo e($poly['doctor_count']); ?> Dokter
                                    </span>
                                    <span class="text-blue-600 font-semibold">
                                        <i class="fas fa-clock mr-1"></i><?php echo e($poly['avg_duration']); ?> menit
                                    </span>
                                </div>
                                <div class="mt-4 pt-4 border-t border-gray-200">
                                    <span class="text-gray-700 font-semibold">Mulai dari Rp
                                        <?php echo e(number_format($poly['price'], 0, ',', '.')); ?></span>
                                </div>
                            </div>
                        </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
                    ...
                    <div class="flex space-x-4 overflow-x-auto pb-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = 0; $i < 7; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            ?>
                            <button
                                class="date-selector flex-shrink-0 text-center p-3 rounded-lg border-2 transition-all duration-300 <?php echo e($isToday ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-blue-300'); ?>"
                                data-date="<?php echo e($date->format('Y-m-d')); ?>"
                                onclick="selectDate('<?php echo e($date->format('Y-m-d')); ?>', this)">
                                <div class="text-sm text-gray-600"><?php echo e($date->format('D')); ?></div>
                                <div class="text-lg font-semibold <?php echo e($isToday ? 'text-blue-600' : 'text-gray-800'); ?>">
                                    <?php echo e($date->format('d')); ?></div>
                                <div class="text-xs text-gray-500"><?php echo e($date->format('M')); ?></div>
                            </button>
                ...
                <div class="grid lg:grid-cols-2 gap-6" id="doctor-schedules">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $doctorSchedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div
                            class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
                            <div class="p-6">
                                <div class="flex items-start space-x-4 mb-4">
                                    <img src="<?php echo e($doctor['photo'] ?? asset('img/doctor-placeholder.jpg')); ?>"
                                        alt="<?php echo e($doctor['name']); ?>" class="w-16 h-16 rounded-full object-cover">
                                    <div class="flex-1">
                                        <h3 class="text-xl font-semibold text-gray-800"><?php echo e($doctor['name']); ?></h3>
                                        <p class="text-blue-600 font-medium"><?php echo e($doctor['specialization']); ?></p>
                                        <p class="text-gray-600 text-sm"><?php echo e($doctor['experience']); ?></p>
                                        <div class="flex items-center mt-2">
                                            <div class="flex text-yellow-400 mr-2">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = 1; $i <= 5; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    <i
                                                        class="fas fa-star <?php echo e($i <= $doctor['rating'] ? '' : 'text-gray-300'); ?>"></i>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                            </div>
                                            <span class="text-sm text-gray-600">(<?php echo e($doctor['reviews']); ?>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="grid grid-cols-3 gap-2">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $doctor['available_times']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <button
                                                ...
                                                data-doctor-id="<?php echo e($doctor['id']); ?>" data-time="<?php echo e($time['time']); ?>"
                                                onclick="selectTimeSlot(<?php echo e($doctor['id']); ?>, '<?php echo e($time['time']); ?>', '<?php echo e($doctor['name']); ?>', this)">
                                                <div class="text-sm font-semibold text-gray-700"><?php echo e($time['time']); ?>

                                                </div>
                                                <div class="text-xs text-gray-500"><?php echo e($time['available_slots']); ?> slot
                                                </div>
                                            </button>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                    </div>
                                ...
                                <div class="flex items-center justify-between pt-4 border-t border-gray-200">
                                    <div class="text-sm text-gray-600">
                                        ...
                                        Konsultasi: Rp <?php echo e(number_format($doctor['consultation_fee'], 0, ',', '.')); ?>
                                    ...
                                    <button
                                        ...
                                        onclick="proceedToBooking(<?php echo e($doctor['id']); ?>)">
                                        Lanjutkan
                                    </button>
                                </div>
                            </div>
    ...
    <div class="container mx-auto px-4">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div>
                <h2 class="text-3xl font-bold text-gray-800 mb-6">Tentang <?php echo e($company->name ?? 'Klinik Kami'); ?></h2>
                <p class="text-gray-600 mb-6 leading-relaxed">
                    <?php echo e($company->description ?? 'Kami adalah klinik kesehatan yang berkomitmen memberikan pelayanan medis terbaik dengan teknologi modern dan tenaga medis yang berpengalaman. Kesehatan Anda adalah prioritas utama kami.'); ?>
            ...
            <div class="relative">
                <img src="<?php echo e(asset('img/clinic-hero.jpg')); ?>" alt="Klinik"
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition duration-300">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 mb-3"><?php echo e($service['name']); ?></h3>
                        <p class="text-gray-600 mb-4"><?php echo e($service['description']); ?></p>
                        <div class="text-sm text-blue-600 font-semibold">
                            Mulai dari Rp <?php echo e(number_format($service['price'], 0, ',', '.')); ?>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition duration-300">
                        <img src="<?php echo e($doctor['photo'] ?? asset('img/doctor-placeholder.jpg')); ?>"
                            alt="<?php echo e($doctor['name']); ?>" class="w-full h-64 object-cover">
                        <div class="p-6">
                            <h3 class="text-xl font-semibold text-gray-800 mb-2"><?php echo e($doctor['name']); ?></h3>
                            <p class="text-blue-600 mb-3"><?php echo e($doctor['specialization']); ?></p>
                            <p class="text-gray-600 text-sm mb-4"><?php echo e($doctor['experience']); ?></p>
                            <div class="flex justify-between items-center">
                                <div class="text-sm text-gray-500">
                                    <i class="fas fa-star text-yellow-400"></i>
                                    <?php echo e($doctor['rating'] ?? '4.8'); ?> (<?php echo e($doctor['reviews'] ?? '120'); ?> review)
                                </div>
                                <button
                ...
                <div class="bg-white rounded-lg shadow-xl p-8">
                    ...
                    <form wire:submit.prevent="submitBooking" class="grid md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['booking_name'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['booking_nik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['booking_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['booking_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['booking_birthdate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['booking_gender'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['booking_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['booking_notes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['booking_agreement'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <div class="text-gray-300">
                                    <?php echo e($company->companyDetail->address ?? 'Jl. Kesehatan No. 123, Jakarta Selatan'); ?>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <div class="text-gray-300"><?php echo e($company->phone ?? '(021) 1234-5678'); ?></div>
                            </div>
                        </div>
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <div class="text-gray-300"><?php echo e($company->email ?? 'info@klinik.com'); ?></div>
                            </div>
                        </div>
                        <div class="flex items-center space-x-4">
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 class="text-3xl font-bold text-gray-800 mb-6">Tentang <?php echo e($company->name ?? 'Klinik Kami'); ?>
    ...
    <footer class="bg-gray-800 text-white py-8">
        <div class="container mx-auto px-4">
            <div class="grid md:grid-cols-4 gap-8">
                <div>
                    <div class="flex items-center space-x-3 mb-4">
                        ...
                        <div class="font-bold text-lg"><?php echo e($company->name ?? 'Klinik Sehat'); ?></div>
                    </div>
            ...
            <div class="border-t border-gray-700 mt-8 pt-6 text-center text-sm text-gray-400">
                <p>&copy; <?php echo e(date('Y')); ?> <?php echo e($company->name ?? 'Klinik Sehat Mandiri'); ?>. All rights reserved.</p>
            </div>
        </div>
    </footer>
</div>
...
</script><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/user/home/user-home-index.blade.php ENDPATH**/ ?>