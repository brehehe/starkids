...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Halo <strong><?php echo e($company->name); ?></strong>,</p>
            ...
            <div class="company-code-box">
                ...
                <div class="company-code"><?php echo e($company->code); ?></div>
            ...
            <p>Terima kasih telah mempercayai <?php echo e(config('app.name')); ?> sebagai partner teknologi perusahaan Anda.</p>

            <br>
            <p>Salam hangat,<br>
                <strong>Tim <?php echo e(config('app.name')); ?></strong>
            </p>
        </div>
        ...
        <div class="footer">
            ...
            <p>Tanggal: <?php echo e(date('d F Y, H:i')); ?> WIB</p>
        </div>
    </div>
</body>

</html>
<?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/mail/company/company-mail.blade.php ENDPATH**/ ?>