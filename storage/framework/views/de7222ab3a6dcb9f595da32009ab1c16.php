                ...
                <table class="w-full text-sm">
                    ...
                    <tbody>
                            ...
                            <tr class="border-b">
                                <td class="py-2" colspan="2">
                                    ...
                                    <p class="text-xs text-gray-500">
                                        @Rp<?php echo e(number_format($action['price'], 0, ',', '.')); ?></p>
                                </td>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $transaction_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $transaction_detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                ...
                                <td colspan="3" class="py-3 px-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <select
                                            ...
                                            class="<?php echo e(in_array($transaction->status, ['draft', 'process', 'take_medicine', 'completed']) ? null : 'bg-gray-100 cursor-not-allowed'); ?> text-sm border rounded px-2 py-1"
                                        ...
                                        <input type="text"
                                            ...
                                            class="<?php echo e(in_array($transaction->status, ['draft', 'process', 'take_medicine', 'completed']) ? null : 'bg-gray-100 cursor-not-allowed'); ?> text-sm border rounded px-2 py-1 w-30">
                                    ...
                                    <div class="mt-2 text-sm text-gray-600">
                                        <input type="text"
                                            ...
                                            class="<?php echo e(in_array($transaction->status, ['draft', 'process', 'take_medicine', 'completed']) ? null : 'bg-gray-100 cursor-not-allowed'); ?> w-full border rounded px-2 py-1">
                                    </div>
                                    <div class="mt-2 text-sm text-gray-600">
                                        <input type="text"
                                            <?php echo e(in_array($transaction->status, ['draft', 'process', 'take_medicine', 'completed']) ? null : 'disabled'); ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $transaction_detail['details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr class="border-b">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$transaction_detail['is_single']): ?>
                                            <td class="py-2">
                                                <input
                                                    wire:model.lazy="transaction_details.<?php echo e($key); ?>.details.<?php echo e($index); ?>.quantity_real"
                                                    type="text" placeholder="Quantity Permintaan"
                                                    <?php echo e(in_array($transaction->status, ['draft', 'process', 'take_medicine', 'completed']) ? null : 'disabled'); ?>

                                                    class="<?php echo e(in_array($transaction->status, ['draft', 'process', 'take_medicine', 'completed']) ? null : 'bg-gray-100 cursor-not-allowed'); ?> text-sm border rounded px-2 py-1 w-48">
                                            </td>
                                            </td>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <td class="py-2 text-center">
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $medicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_medicine => $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/sale/pos/recipe/admin-sale-pos-recipe-index-old.blade.php ENDPATH**/ ?>