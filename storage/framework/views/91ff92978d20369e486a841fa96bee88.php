...
<div class="<?php echo e($personalize['wrapper.first']); ?>"
    ...
    <div x-ref="dropdown"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($text): ?>
            <div class="<?php echo e($personalize['action.wrapper']); ?>">
                <span class="<?php echo e($personalize['action.text']); ?>"><?php echo e($text); ?></span>
                <button type="button" 
...
<?php endif; ?>
<?php $component->withAttributes(['icon' => TallStackUi::icon('chevron-down'),'internal' => true,'class' => ''.e($personalize['action.icon']).'','x-bind:class' => '{ \'transform rotate-180\': animate && show }']); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\DynamicComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => $icon,'internal' => true,'class' => ''.e($personalize['action.icon']).'','x-bind:class' => '{ \'transform rotate-180\': animate && show }']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\DynamicComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['floating' => $personalize['floating.default'],'class' => $personalize['floating.class'],'offset' => '5','position' => $position,'x-anchor' => '$refs.dropdown','role' => 'menu']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <div class="<?php echo e($personalize['slot.wrapper']); ?>">
                <?php echo $slot; ?>
...
<?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/vendor/tallstackui/tallstackui/src/resources/views/components/dropdown/dropdown.blade.php ENDPATH**/ ?>