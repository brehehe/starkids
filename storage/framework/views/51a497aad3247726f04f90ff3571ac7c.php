<div>
    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 overflow-hidden mb-6">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_5 = true; $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_5 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            ...
                            <td><?php echo e($detail->transaction ? \Carbon\Carbon::parse($detail->transaction->created_at)->locale('id')->isoFormat('D MMMM Y HH:mm') : '-'); ?></td>
                            <td><?php echo e($detail->transaction->code ?? '-'); ?></td>
                            <td><?php echo e($detail->product->name ?? $detail->name); ?></td>
                            <td><?php echo e($detail->nurse->name ?? '-'); ?></td>
                            <td><?php echo e($detail->doctor->name ?? '-'); ?></td>
                            <td><?php echo e(number_format($detail->sub_total_price, 0, ',', '.')); ?></td>
                        </tr>
        ...
        <div class="px-5 py-4 bg-gray-50/80 border-t border-gray-200">
             <?php echo e($details->links('vendor.livewire.custom')); ?>
    ...
    <script>
        document.addEventListener('livewire:initialized', () => {
            ...
            let qtyChart = new Chart(qtyCtx, {
                type: 'bar',
                data: {
                    labels: <?php echo json_encode($chartQtyLabels); ?>,
                    datasets: [{
                        label: 'Total Kuantitas',
                        data: <?php echo json_encode($chartQtyData); ?>,
            ...
            let revChart = new Chart(revCtx, {
                type: 'bar',
                data: {
                    labels: <?php echo json_encode($chartRevLabels); ?>,
                    datasets: [{
                        label: 'Total Biaya',
                        data: <?php echo json_encode($chartRevData); ?>,
...
<?php $__env->stopPush(); ?><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/report/action/admin-report-action-index.blade.php ENDPATH**/ ?>