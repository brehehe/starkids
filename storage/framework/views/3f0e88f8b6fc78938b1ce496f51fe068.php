...
<head>
    ...
    <title>Antrian Klinik - <?php echo e(config('app.name')); ?></title>
...
<body class="antialiased text-slate-800 dark:text-white min-h-screen transition-colors duration-300 bg-gray-50 dark:bg-slate-950">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="<?php echo e(route('queue.create')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200 flex items-center space-x-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                            </svg>
                            <span>Daftar Antrian</span>
                        </a>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200">
                            Dashboard Admin
                        </a>
        ...
        <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentQueue): ?>
                            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-8 mb-4">
                                <div class="text-6xl font-bold text-blue-600 dark:text-blue-400 mb-2"><?php echo e($currentQueue['queue_number']); ?></div>
                                <div class="text-xl text-gray-700 dark:text-gray-300"><?php echo e($currentQueue['patient_name']); ?></div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                            <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                                <div class="text-2xl font-bold text-yellow-600 dark:text-yellow-400"><?php echo e($waitingCount); ?></div>
                                <div class="text-sm text-yellow-700 dark:text-yellow-300">Antrian Menunggu</div>
                            </div>
                            <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                                <div class="text-2xl font-bold text-green-600 dark:text-green-400"><?php echo e(collect($todayQueues)->where('status', 'Selesai')->count()); ?></div>
                                <div class="text-sm text-green-700 dark:text-green-300">Selesai Hari Ini</div>
                            </div>
                            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                                <div class="text-2xl font-bold text-blue-600 dark:text-blue-400"><?php echo e(count($todayQueues)); ?></div>
            ...
            <div class="bg-white dark:bg-slate-800 overflow-hidden shadow-xl sm:rounded-lg border border-gray-200 dark:border-slate-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-700">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e(now()->format('d F Y')); ?></p>
                </div>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
                        ...
                        <tbody class="bg-white dark:bg-slate-800 divide-y divide-gray-200 dark:divide-slate-700" id="queue-table-body">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_5 = true; $__currentLoopData = $todayQueues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $queue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_5 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors duration-200">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-lg font-bold text-gray-900 dark:text-white"><?php echo e($queue['queue_number']); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($queue['patient_name']); ?></div>
                                        <div class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($queue['gender']); ?>, <?php echo e($queue['age']); ?> tahun</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                        <?php echo e(\Carbon\Carbon::parse($queue['queue_time'])->format('H:i')); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($queue['status'] === 'Menunggu'): ?>
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400">
                                                Menunggu
                                            </span>
                                        <?php elseif($queue['status'] === 'Sedang Dilayani'): ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            setInterval(() => {
                fetch('<?php echo e(route("queue.data")); ?>')
...
<?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/queue/index.blade.php ENDPATH**/ ?>