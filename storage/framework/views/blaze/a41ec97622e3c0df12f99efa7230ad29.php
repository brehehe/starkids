<?php
if (!function_exists('__a41ec97622e3c0df12f99efa7230ad29')):
function __a41ec97622e3c0df12f99efa7230ad29($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php $__blaze->ensureRequired('/Users/macbookair/Documents/mediction/mediction.id/vendor/livewire/flux/src/../stubs/resources/views/flux/with-tooltip.blade.php', $__blaze->compiledPath.'/8ec5a9be2729f6e1712bf78fc4f15bac.php'); ?>
<?php if (isset($__slots8ec5a9be2729f6e1712bf78fc4f15bac)) { $__slotsStack8ec5a9be2729f6e1712bf78fc4f15bac[] = $__slots8ec5a9be2729f6e1712bf78fc4f15bac; } ?>
<?php if (isset($__attrs8ec5a9be2729f6e1712bf78fc4f15bac)) { $__attrsStack8ec5a9be2729f6e1712bf78fc4f15bac[] = $__attrs8ec5a9be2729f6e1712bf78fc4f15bac; } ?>
<?php $__attrs8ec5a9be2729f6e1712bf78fc4f15bac = ['attributes' => $attributes]; ?>
<?php $__slots8ec5a9be2729f6e1712bf78fc4f15bac = []; ?>
<?php $__blaze->pushData($__attrs8ec5a9be2729f6e1712bf78fc4f15bac); ?>
<?php ob_start(); ?>
    <?php $__blaze->ensureRequired('/Users/macbookair/Documents/mediction/mediction.id/vendor/livewire/flux/src/../stubs/resources/views/flux/button-or-link-pure.blade.php', $__blaze->compiledPath.'/64a02e3483c5de86ab3bc1bee572d78b.php'); ?>
<?php if (isset($__slots64a02e3483c5de86ab3bc1bee572d78b)) { $__slotsStack64a02e3483c5de86ab3bc1bee572d78b[] = $__slots64a02e3483c5de86ab3bc1bee572d78b; } ?>
<?php if (isset($__attrs64a02e3483c5de86ab3bc1bee572d78b)) { $__attrsStack64a02e3483c5de86ab3bc1bee572d78b[] = $__attrs64a02e3483c5de86ab3bc1bee572d78b; } ?>
<?php $__attrs64a02e3483c5de86ab3bc1bee572d78b = ['type' => $type,'attributes' => $attributes->class($classes),'dataFluxButton' => true]; ?>
<?php $__slots64a02e3483c5de86ab3bc1bee572d78b = []; ?>
<?php $__blaze->pushData($__attrs64a02e3483c5de86ab3bc1bee572d78b); ?>
<?php ob_start(); ?>
        <?php if ($loading): ?>
            <div class="absolute inset-0 flex items-center justify-center opacity-0" data-flux-loading-indicator>
                <?php $__blaze->ensureRequired('/Users/macbookair/Documents/mediction/mediction.id/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/index.blade.php', $__blaze->compiledPath.'/1cb259fe6a7e5ee25397fd6182080d08.php'); ?>
<?php $__blaze->pushData(['icon' => 'loading','variant' => $iconVariant,'class' => $iconClasses]); ?>
<?php __1cb259fe6a7e5ee25397fd6182080d08($__blaze, ['icon' => 'loading','variant' => $iconVariant,'class' => $iconClasses], [], ['variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
            </div>
        <?php endif; ?>
...
<?php __1cb259fe6a7e5ee25397fd6182080d08($__blaze, ['icon' => $iconLeading,'variant' => $iconVariant,'class' => $iconClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php __1cb259fe6a7e5ee25397fd6182080d08($__blaze, ['icon' => $iconTrailing,'variant' => $iconTrailingVariant,'class' => $iconTrailingClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
        <?php elseif ($iconTrailing): ?>
            <?php echo e($iconTrailing); ?>

        <?php endif; ?>
    <?php $__slots64a02e3483c5de86ab3bc1bee572d78b['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots64a02e3483c5de86ab3bc1bee572d78b); ?>
<?php __64a02e3483c5de86ab3bc1bee572d78b($__blaze, $__attrs64a02e3483c5de86ab3bc1bee572d78b, $__slots64a02e3483c5de86ab3bc1bee572d78b, ['type', 'attributes', 'dataFluxButton'], ['dataFluxButton' => 'data-flux-button'], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack64a02e3483c5de86ab3bc1bee572d78b)) { $__slots64a02e3483c5de86ab3bc1bee572d78b = array_pop($__slotsStack64a02e3483c5de86ab3bc1bee572d78b); } ?>
<?php if (! empty($__attrsStack64a02e3483c5de86ab3bc1bee572d78b)) { $__attrs64a02e3483c5de86ab3bc1bee572d78b = array_pop($__attrsStack64a02e3483c5de86ab3bc1bee572d78b); } ?>
<?php $__blaze->popData(); ?>
<?php $__slots8ec5a9be2729f6e1712bf78fc4f15bac['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots8ec5a9be2729f6e1712bf78fc4f15bac); ?>
<?php __8ec5a9be2729f6e1712bf78fc4f15bac($__blaze, $__attrs8ec5a9be2729f6e1712bf78fc4f15bac, $__slots8ec5a9be2729f6e1712bf78fc4f15bac, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack8ec5a9be2729f6e1712bf78fc4f15bac)) { $__slots8ec5a9be2729f6e1712bf78fc4f15bac = array_pop($__slotsStack8ec5a9be2729f6e1712bf78fc4f15bac); } ?>
<?php if (! empty($__attrsStack8ec5a9be2729f6e1712bf78fc4f15bac)) { $__attrs8ec5a9be2729f6e1712bf78fc4f15bac = array_pop($__attrsStack8ec5a9be2729f6e1712bf78fc4f15bac); } ?>
<?php $__blaze->popData(); ?>
<?php
echo $__blaze->processPassthroughContent('ltrim', ltrim(ob_get_clean()));
} endif; ?><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/vendor/livewire/flux/src/../stubs/resources/views/flux/button/index.blade.php ENDPATH**/ ?>