<?php
if (!function_exists('__8ec5a9be2729f6e1712bf78fc4f15bac')):
function __8ec5a9be2729f6e1712bf78fc4f15bac($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php ob_start(); ?>
    ...
    <?php $__slots65ebe32a313649b2003c89797eef1bef['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots65ebe32a313649b2003c89797eef1bef); ?>
<?php __65ebe32a313649b2003c89797eef1bef($__blaze, $__attrs65ebe32a313649b2003c89797eef1bef, $__slots65ebe32a313649b2003c89797eef1bef, ['content', 'position', 'kbd'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/vendor/livewire/flux/src/../stubs/resources/views/flux/with-tooltip.blade.php ENDPATH**/ ?>