                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="text-xs text-gray-500"><?php echo e($user->email ?? $user->phone); ?></div>
                        </td>
                        <td class="center">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payroll): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payroll->payment_type == 'monthly'): ?>
                                    <span class="px-2 py-1 bg-blue-100 text-blue-800 rounded text-xs">Bulanan</span>
                                <?php elseif($payroll->payment_type == 'weekly'): ?>
                        ...
                        <td class="text-right font-medium text-gray-800">
                            Rp <?php echo e(number_format($payroll ? $payroll->basic_salary : 0, 0, ',', '.')); ?>

                        </td>
                        <td class="center">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payroll && $payroll->components->count() > 0): ?>
                                <div x-data="{ open: false }" class="relative inline-block text-left" @mouseleave="open = false">
                                    <button @mouseenter="open = true" @click="open = !open" class="inline-flex items-center justify-center bg-blue-50 text-blue-700 hover:bg-blue-100 text-xs font-bold px-3 py-1.5 rounded-full border border-blue-200 transition-colors cursor-pointer">
                                        <i class="fas fa-list-ul mr-1"></i> <?php echo e($payroll->components->count()); ?> Komponen
                                    </button>
                                    ...
                                    <div x-show="open" x-transition class="absolute z-10 w-64 mt-2 -right-10 sm:right-0 bg-white rounded-lg shadow-xl border border-gray-200" style="display: none;">
                                        ...
                                        <div class="p-3 max-h-48 overflow-y-auto text-left">
                                            <ul class="space-y-2">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $payroll->components; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empComp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    <li class="flex justify-between items-center text-sm">
                                                        <span class="text-gray-600 truncate mr-2" title="<?php echo e($empComp->component->name ?? '-'); ?>"><?php echo e($empComp->component->name ?? '-'); ?></span>
                                                        <span class="font-medium whitespace-nowrap <?php echo e(($empComp->component->type ?? '') == 'allowance' ? 'text-green-600' : 'text-red-500'); ?>">
                                                            <?php echo e(($empComp->component->type ?? '') == 'allowance' ? '+' : '-'); ?>Rp <?php echo e(number_format($empComp->amount, 0, ',', '.')); ?>
                        ...
                        <td class="text-right font-bold text-blue-700">
                            Rp <?php echo e(number_format($totalGajih, 0, ',', '.')); ?>

                        </td>
                        <td class="center">
                            <button wire:click="edit('<?php echo e($user->id); ?>')" class="btn-action btn-edit bg-green-50 text-green-600 hover:bg-green-100 hover:text-green-700" title="Atur Gaji Pegawai">
            ...
            <div class="flex justify-between items-center p-6 border-b bg-gray-50 rounded-t-2xl">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 font-medium whitespace-nowrap overflow-hidden text-ellipsis max-w-[300px]"><?php echo e($user_name); ?></p>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($allComponents->count() > 0): ?>
                    <div class="space-y-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $allComponents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="flex items-center justify-between p-3 rounded-xl border border-gray-200 hover:border-blue-300 hover:shadow-sm transition-all bg-white group">
                                <div class="flex items-center flex-1 gap-3">
                                    <div class="flex items-center h-5">
                                        <input wire:model.live="selected_components.<?php echo e($comp->id); ?>" id="comp_<?php echo e($comp->id); ?>" type="checkbox" class="w-5 h-5 text-blue-600 bg-white border-gray-300 rounded focus:ring-blue-500 cursor-pointer">
                                    </div>
                                    <div class="ml-2 flex-col">
                                        <label for="comp_<?php echo e($comp->id); ?>" class="text-sm font-bold text-gray-800 cursor-pointer select-none">
                                            <?php echo e($comp->name); ?>

                                        </label>
                                        <div class="text-xs <?php echo e($comp->type == 'allowance' ? 'text-green-600' : 'text-red-500'); ?> font-medium">
                                            <?php echo e($comp->type == 'allowance' ? 'Tunjangan (+)' : 'Potongan (-)'); ?>

                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($comp->is_taxable): ?> <span class="text-gray-400">| Kena Pajak</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="w-1/3 min-w-[150px]">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($selected_components[$comp->id])): ?>
                                        <div class="relative">
                                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                <span class="text-gray-500 sm:text-xs font-semibold">Rp</span>
                                            </div>
                                            <input type="number" wire:model.defer="component_amounts.<?php echo e($comp->id); ?>" 
                                                ...
                                                placeholder="<?php echo e($comp->default_amount > 0 ? (int)$comp->default_amount : '0'); ?>">
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/hr/master-payroll/admin-hr-master-payroll-setting-index.blade.php ENDPATH**/ ?>