    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 overflow-hidden mb-6">
        <div class="table-container">
            <table class="table">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_5 = true; $__currentLoopData = $shifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $shift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_5 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'shift-'.e($shift->id).''; ?>wire:key="shift-<?php echo e($shift->id); ?>">
                        <td class="center"><?php echo e($shifts->firstItem() + $index); ?></td>
                        <td class="font-medium"><?php echo e($shift->name); ?></td>
                        <td class="center"><?php echo e(\Carbon\Carbon::createFromFormat('H:i:s', $shift->start_time)->format('H:i')); ?></td>
                        <td class="center"><?php echo e(\Carbon\Carbon::createFromFormat('H:i:s', $shift->end_time)->format('H:i')); ?></td>
                        <td class="center">
                        ...
                        <td class="center">
                            <div class="flex items-center justify-center gap-2">
                                <button wire:click="edit('<?php echo e($shift->id); ?>')" class="btn-action btn-edit" title="Edit Shift">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button wire:click="confirmDelete('<?php echo e($shift->id); ?>')" class="btn-action btn-delete" title="Hapus Shift">
        ...
        <div class="px-5 py-4 bg-gray-50/80 border-t border-gray-200">
            <div class="flex items-center justify-between">
                <div class="text-sm text-gray-700">
                    Menampilkan <span class="font-medium"><?php echo e($shifts->firstItem() ?? 0); ?></span> sampai <span
                        class="font-medium"><?php echo e($shifts->lastItem() ?? 0); ?></span> dari <span
                        class="font-medium"><?php echo e($shifts->total() ?? 0); ?></span> shift
                </div>
                <div>
                    <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                        <?php echo e($shifts->links('vendor.livewire.custom')); ?>
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full transform transition-all scale-95 duration-300 ease-out animate-fade-in"
            ...
            <div class="flex justify-between items-center p-6 border-b">
                <div class="flex items-center gap-2">
                    ...
                    <h2 class="text-xl font-semibold text-gray-800"><?php echo e($data_id ? 'Edit' : 'Tambah'); ?> Shift Kerja</h2>
                </div>
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/hr/shift/admin-hr-shift-index.blade.php ENDPATH**/ ?>