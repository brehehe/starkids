<?php
if (!function_exists('_0440b5bd9e5dd9d0dae6e6bbfd72a7ce')):
function _0440b5bd9e5dd9d0dae6e6bbfd72a7ce($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/vendor/livewire/flux/stubs/resources/views/flux/icon/folder-open.blade.php ENDPATH**/ ?>