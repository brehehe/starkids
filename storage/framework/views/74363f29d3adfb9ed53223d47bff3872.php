...
<div x-data="tallstackui_card(<?php echo \Illuminate\Support\Js::from($initializeMinimized)->toHtml() ?>)" class="<?php echo e($personalize['wrapper.first']); ?>" x-cloak <?php if($close): ?> x-show="show" <?php endif; ?> wire:ignore.self>
...
<?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/vendor/tallstackui/tallstackui/src/resources/views/components/card.blade.php ENDPATH**/ ?>