<div>
    <div class="mb-4">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-[#1E3A8A]"><?php echo e($journal_id ? 'Edit' : 'Tambah'); ?> Jurnal Umum</h1>
            </div>
            <div>
                <a href="<?php echo e(route('user.finance.general-journal')); ?>" class="btn btn-secondary">
                        ...
                        <tfoot class="bg-gray-50">
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="px-4 py-3">
                                    ...
                                    ?>
                                    <span class="font-bold <?php echo e($balance == 0 ? 'text-green-600' : 'text-red-600'); ?>">
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/finance/general-journal/detail/admin-finance-general-journal-detail-index.blade.php ENDPATH**/ ?>