    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 overflow-hidden mb-6">
        <div class="table-container">
            <table class="table">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_5 = true; $__currentLoopData = $purchaseProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $purchaseProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_5 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            <td class="w-1 center"><?php echo e($index + 1); ?></td>
                            <td><?php echo e($purchaseProduct->product->name); ?></td>
                            <td class="center"><?php echo e($purchaseProduct->quantity); ?></td>
                            <td>
                                Rp<?php echo e(number_format($purchaseProduct->hna ?? 0, 0, ',', '.')); ?>

                            </td>
                            <td>
                                Rp<?php echo e(number_format($purchaseProduct->ppn ?? 0, 0, ',', '.')); ?>

                            </td>
                            <td>
                                Rp<?php echo e(number_format($purchaseProduct->sub_total ?? 0, 0, ',', '.')); ?>
        ...
        <div class="px-5 py-4 bg-gray-50/80 border-t border-gray-200">
            <div class="flex items-center justify-between">
                <div class="text-sm text-gray-700">
                    Menampilkan <span class="font-medium"><?php echo e($purchaseProducts->firstItem()); ?></span> sampai <span
                        class="font-medium"><?php echo e($purchaseProducts->lastItem()); ?></span> dari <span
                        class="font-medium"><?php echo e($purchaseProducts->total()); ?></span> hasil
                </div>
                <div>
                    <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                        <?php echo e($purchaseProducts->links('vendor.livewire.custom')); ?> <!-- Menampilkan pagination -->
                    </nav>
                </div>
            </div>
        </div>
    </div>
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/report/purchase-product/admin-report-purchase-product-index.blade.php ENDPATH**/ ?>