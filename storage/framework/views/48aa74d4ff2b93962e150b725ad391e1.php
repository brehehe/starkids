<?php
if (!function_exists('_48aa74d4ff2b93962e150b725ad391e1')):
function _48aa74d4ff2b93962e150b725ad391e1($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<th <?php echo e($attributes->class($classes)); ?> data-flux-column>
    <?php if ($sortable): ?>
        <div class="flex in-[.group\/center-align]:justify-center in-[.group\/end-align]:justify-end">
            <?php $__blaze->ensureRequired('/Users/macbookair/Documents/mediction/mediction.id/vendor/livewire/flux/src/../stubs/resources/views/flux/table/sortable.blade.php', $__blaze->compiledPath.'/0557fd18ac8b3473b418119ca29b2bc8.php'); ?>
<?php if (isset($__slots0557fd18ac8b3473b418119ca29b2bc8)) { $__slotsStack0557fd18ac8b3473b418119ca29b2bc8[] = $__slots0557fd18ac8b3473b418119ca29b2bc8; } ?>
<?php if (isset($__attrs0557fd18ac8b3473b418119ca29b2bc8)) { $__attrsStack0557fd18ac8b3473b418119ca29b2bc8[] = $__attrs0557fd18ac8b3473b418119ca29b2bc8; } ?>
<?php $__attrs0557fd18ac8b3473b418119ca29b2bc8 = ['sorted' => $sorted,'direction' => $direction]; ?>
<?php $__slots0557fd18ac8b3473b418119ca29b2bc8 = []; ?>
<?php $__blaze->pushData($__attrs0557fd18ac8b3473b418119ca29b2bc8); ?>
<?php ob_start(); ?>
                <div><?php echo e($slot); ?></div>
            <?php $__slots0557fd18ac8b3473b418119ca29b2bc8['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots0557fd18ac8b3473b418119ca29b2bc8); ?>
<?php _0557fd18ac8b3473b418119ca29b2bc8($__blaze, $__attrs0557fd18ac8b3473b418119ca29b2bc8, $__slots0557fd18ac8b3473b418119ca29b2bc8, ['sorted', 'direction'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack0557fd18ac8b3473b418119ca29b2bc8)) { $__slots0557fd18ac8b3473b418119ca29b2bc8 = array_pop($__slotsStack0557fd18ac8b3473b418119ca29b2bc8); } ?>
<?php if (! empty($__attrsStack0557fd18ac8b3473b418119ca29b2bc8)) { $__attrs0557fd18ac8b3473b418119ca29b2bc8 = array_pop($__attrsStack0557fd18ac8b3473b418119ca29b2bc8); } ?>
<?php $__blaze->popData(); ?>
        </div>
    <?php else: ?>
...
} endif; ?><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/vendor/livewire/flux/stubs/resources/views/flux/table/column.blade.php ENDPATH**/ ?>