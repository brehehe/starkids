<div>
    <div class="mb-4">
        <div class="flex items-center justify-between">
            ...
            <div>
                <a href="<?php echo e(route('user.finance.adjustment-journal.detail')); ?>" class="btn btn-primary">
                        ...
                        <div class="flex-1 grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div class="flex items-center space-x-3">
                                <div class="flex-shrink-0 w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center">
                                    <span class="text-purple-600 font-bold text-sm"><?php echo e($journals->firstItem() + $index); ?></span>
                                </div>
                                <div>
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div class="flex gap-2">
                                <a href="<?php echo e(route('user.finance.adjustment-journal.detail', ['id' => $journal->id])); ?>" class="btn btn-sm btn-warning">
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/finance/adjustment-journal/admin-finance-adjustment-journal-index.blade.php ENDPATH**/ ?>