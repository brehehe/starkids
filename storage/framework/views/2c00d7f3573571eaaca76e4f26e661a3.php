<div>
    <?php echo $__env->make('livewire.admin.master.product.factory.admin-master-product-factory-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <div class="mb-4">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-[#1E3A8A]">Pabrik Produk</h1>
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/master/product/factory/admin-master-product-factory-index.blade.php ENDPATH**/ ?>