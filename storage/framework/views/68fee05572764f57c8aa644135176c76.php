<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold mt-2">Rp <?php echo e(number_format($this->totalAssets, 0, ',', '.')); ?></h3>
                </div>
        ...
        <div class="bg-gradient-to-br from-red-500 to-red-600 rounded-xl shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold mt-2">Rp <?php echo e(number_format($this->totalLiabilities, 0, ',', '.')); ?></h3>
                </div>
                <div class="bg-white/20 rounded-full p-4">
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold mt-2">Rp <?php echo e(number_format($this->totalEquity, 0, ',', '.')); ?></h3>
                </div>
                <div class="bg-white/20 rounded-full p-4">
        ...
        <div class="bg-gradient-to-br from-<?php echo e($this->balanceStatus['is_balanced'] ? 'green' : 'orange'); ?>-500 to-<?php echo e($this->balanceStatus['is_balanced'] ? 'green' : 'orange'); ?>-600 rounded-xl shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-white/90 text-sm font-medium">Status Neraca</p>
                    <h3 class="text-xl font-bold mt-2"><?php echo e($this->balanceStatus['is_balanced'] ? 'Seimbang' : 'Tidak Seimbang'); ?></h3>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$this->balanceStatus['is_balanced']): ?>
                        <p class="text-xs mt-1">Selisih: Rp <?php echo e(number_format(abs($this->balanceStatus['difference']), 0, ',', '.')); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <div class="bg-white/20 rounded-full p-4">
                    <i class="fas fa-<?php echo e($this->balanceStatus['is_balanced'] ? 'check-circle' : 'exclamation-triangle'); ?> text-2xl"></i>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div class="p-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $detailCategoryAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detailCategoryAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(strpos($categoryName, 'aktiva') !== false): ?>
                        
                        <div class="mb-4">
                            <div class="flex justify-between items-center bg-blue-50 px-4 py-3 rounded-lg mb-2">
                                <h3 class="font-bold text-blue-900 text-lg"><?php echo e($detailCategoryAccount); ?></h3>
                                <span class="font-bold text-blue-900">Rp <?php echo e(number_format(abs($detailCategoryTotals[$index]['balance'] ?? 0), 0, ',', '.')); ?></span>
                            </div>
                ...
                <div class="border-t-2 border-blue-900 mt-4 pt-4">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="font-bold text-blue-900 text-xl">Rp <?php echo e(number_format(abs($this->totalAssets), 0, ',', '.')); ?></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $detailCategoryAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detailCategoryAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(strpos($categoryName, 'kewajiban') !== false): ?>
                            <div class="mb-4">
                                <div class="flex justify-between items-center bg-red-50 px-4 py-3 rounded-lg mb-2">
                                    <h4 class="font-bold text-red-900"><?php echo e($detailCategoryAccount); ?></h4>
                                    <span class="font-bold text-red-900">Rp <?php echo e(number_format(abs($detailCategoryTotals[$index]['balance'] ?? 0), 0, ',', '.')); ?></span>
                                </div>
                    ...
                    <div class="border-t border-gray-300 mt-2 pt-2">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-bold text-gray-900">Rp <?php echo e(number_format(abs($this->totalLiabilities), 0, ',', '.')); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $detailCategoryAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detailCategoryAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(strpos($categoryName, 'modal') !== false): ?>
                            <div class="mb-4">
                                <div class="flex justify-between items-center bg-purple-50 px-4 py-3 rounded-lg mb-2">
                                    <h4 class="font-bold text-purple-900"><?php echo e($detailCategoryAccount); ?></h4>
                                    <span class="font-bold text-purple-900">Rp <?php echo e(number_format(abs($detailCategoryTotals[$index]['balance'] ?? 0), 0, ',', '.')); ?></span>
                                </div>
                    ...
                    <div class="border-t border-gray-300 mt-2 pt-2">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-bold text-gray-900">Rp <?php echo e(number_format(abs($this->totalEquity), 0, ',', '.')); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t-2 border-purple-900 mt-4 pt-4">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="font-bold text-purple-900 text-xl">Rp <?php echo e(number_format(abs($this->totalLiabilities + $this->totalEquity), 0, ',', '.')); ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6 mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="text-right">
                ...
                <?php else: ?>
                    ...
                    <p class="text-sm mt-1">Selisih: Rp <?php echo e(number_format(abs($this->balanceStatus['difference']), 0, ',', '.')); ?></p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
        ...
        <div class="grid grid-cols-3 gap-4 mt-4 pt-4 border-t">
            <div class="text-center">
                ...
                <p class="font-bold text-lg text-blue-600">Rp <?php echo e(number_format(abs($this->totalAssets), 0, ',', '.')); ?></p>
            </div>
            <div class="text-center">
                <p class="text-sm text-gray-600 mb-1">Total Kewajiban</p>
                <p class="font-bold text-lg text-red-600">Rp <?php echo e(number_format(abs($this->totalLiabilities), 0, ',', '.')); ?></p>
            </div>
            <div class="text-center">
                <p class="text-sm text-gray-600 mb-1">Total Modal</p>
                <p class="font-bold text-lg text-purple-600">Rp <?php echo e(number_format(abs($this->totalEquity), 0, ',', '.')); ?></p>
            </div>
        </div>
    </div>
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/finance/balance-sheet/admin-finance-balance-sheet-index.blade.php ENDPATH**/ ?>