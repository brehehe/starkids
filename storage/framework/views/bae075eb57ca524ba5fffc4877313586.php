<div>
    <?php echo $__env->make('livewire.admin.sale.product-price.admin-sale-product-price-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <div class="mb-4">
        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold mt-2"><?php echo number_format($totalProducts, 0, ',', '.'); ?></h3>
                </div>
        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold mt-2"><?php echo number_format($totalQuantity, 0, ',', '.'); ?></h3>
                </div>
                <div class="bg-white/20 rounded-full p-3">
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold mt-2">Rp <?php echo number_format($totalHNA, 0, ',', '.'); ?></h3>
                </div>
                <div class="bg-white/20 rounded-full p-3">
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold mt-2">Rp <?php echo number_format($totalPrice, 0, ',', '.'); ?></h3>
                </div>
                <div class="bg-white/20 rounded-full p-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <select class="form-control" wire:model.live="product_factory_id">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $factories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $factory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->is_head): ?>
                            <th>Aksi</th>
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $productPrices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $productPrice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            ...
                            <td><?php echo e($productPrice->product?->productType?->name ?? '-'); ?></td>
                            <td><?php echo number_format($productPrice?->product?->productStock?->quantity ?? 0, 0, ',', '.'); ?></td>
                            <td>Rp <?php echo number_format($productPrice->hpp_average, 0, ',', '.'); ?></td>
                            <td>Rp <?php echo number_format($productPrice->hpp_average * $productPrice?->product?->productStock?->quantity ?? 0, 0, ',', '.'); ?></td>
                            <td>Rp <?php echo number_format($productPrice->price, 0, ',', '.'); ?></td>
                            <td>Rp <?php echo number_format($productPrice->price * $productPrice?->product?->productStock?->quantity ?? 0, 0, ',', '.'); ?></td>
                                ...
                                <td class="center">
                                    <div class="flex items-center">
                                        <button
                                            ...
                                            wire:click="edit('<?php echo e($productPrice->id); ?>')">
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/sale/product-price/admin-sale-product-price-index.blade.php ENDPATH**/ ?>