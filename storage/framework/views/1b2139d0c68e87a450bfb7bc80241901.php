<div wire:ignore.self id="modalAction"
    ...
    <div
        ...
        <div class="px-6 py-4 text-gray-600 space-y-4 overflow-y-auto flex-grow" style="max-height: 80vh">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($type, ['action', 'odontogram_action'])): ?>
                <div
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_5 = true; $__currentLoopData = $actions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_5 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr class="border-b hover:bg-gray-50">
                                        <td class="py-3 px-4"><?php echo e($actions->firstItem() + $index); ?></td>
                                        <td class="py-3 px-4"><?php echo e($action->name); ?></td>
                                        <td class="py-3 px-4"><?php echo e($action->description ?? '-'); ?></td>
                                        <td class="py-3 px-4">Rp
                                            <?php echo e(number_format($action->productPrice?->price ?? 0, 0, ',', '.')); ?></td>
                                        <td class="py-3 px-4">
                                            <?php echo e($action?->productStock?->quantity ?? 0); ?>

                                        </td>
                                        <td class="py-3 px-4">
                                            <button class="text-blue-600 hover:text-blue-800 mx-1"
                                                wire:click="<?php echo e($type == 'odontogram_action' ? 'choiceOdontogramAction' : 'choiceAction'); ?>('<?php echo e($action->id); ?>')" title="Pilih">
                                                <i class="fas <?php echo e($type == 'odontogram_action' ? 'fa-check' : 'fa-eye'); ?>"></i>
                                            </button>
                                        </td>
                                    </tr>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div>
                                <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px"
                                    ...
                                    <?php echo e($actions->links('vendor.livewire.custom')); ?>
...
<div wire:ignore.self id="modalProduct"
    ...
    <div
        ...
        <div class="px-6 py-4 text-gray-600 space-y-4 overflow-y-auto flex-grow" style="max-height: 80vh">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($type, ['medicine'])): ?>
                <div
                    class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 overflow-hidden mb-6">
                    <div class="table-container">
                        <table class="table">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_5 = true; $__currentLoopData = $medicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_5 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr class="border-b hover:bg-gray-50">
                                        <td class="py-3 px-4"><?php echo e($medicines->firstItem() + $index); ?></td>
                                        <td class="py-3 px-4"><?php echo e($medicine->name); ?></td>
                                        <td class="py-3 px-4"><?php echo e($medicine->description ?? '-'); ?></td>
                                        <td class="py-3 px-4">Rp
                                            <?php echo e(number_format($medicine->productPrice?->price ?? 0, 0, ',', '.')); ?></td>
                                        <td class="py-3 px-3">
                                            <?php echo e($medicine?->productStock?->quantity ?? 0); ?>

                                        </td>
                                        <td class="py-3 px-4">
                                            <button class="text-blue-600 hover:text-blue-800 mx-1"
                                                wire:click="choiceProduct('<?php echo e($medicine->id); ?>')" title="Edit">
                    ...
                    <div class="px-5 py-4 bg-gray-50/80 border-t border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="text-sm text-gray-700">
                                Menampilkan <span class="font-medium"><?php echo e($medicines->firstItem()); ?></span> sampai
                                <span class="font-medium"><?php echo e($medicines->lastItem()); ?></span> dari <span
                                    class="font-medium"><?php echo e($medicines->total()); ?></span> hasil
                            </div>
                            <div>
                                <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px"
                                    aria-label="Pagination">
                                    <?php echo e($medicines->links('vendor.livewire.custom')); ?>
...
<div wire:ignore.self id="modal"
    ...
    <div
        ...
        <div class="px-6 py-4 text-gray-600 space-y-4 overflow-y-auto flex-grow" style="max-height: 80vh">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($type, ['icd10', 'icd9'])): ?>
                <div
                    class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 overflow-hidden mb-6">
                    <div class="table-container">
                        <table class="table">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_5 = true; $__currentLoopData = $icds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $icd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_5 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr>
                                        <td class="center"><?php echo e($icds->firstItem() + $index); ?></td>
                                        <td><?php echo e($icd->code); ?></td>
                                        <td><?php echo e($icd->display); ?></td>
                                        <td class="center">
                                            <div class="flex items-center">
                                                <button
                                                    class="btn btn-icon text-blue-500 hover:text-blue-600 transition-colors edit-btn"
                                                    wire:click="choiceICD('<?php echo e($icd->id); ?>')">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                            </div>
                                        </td>
                    ...
                    <div class="px-5 py-4 bg-gray-50/80 border-t border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="text-sm text-gray-700">
                                Menampilkan <span class="font-medium"><?php echo e($icds->firstItem()); ?></span> sampai <span
                                    class="font-medium"><?php echo e($icds->lastItem()); ?></span> dari <span
                                    class="font-medium"><?php echo e($icds->total()); ?></span> hasil
                            </div>
                            <div>
                                <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px"
                                    aria-label="Pagination">
                                    <?php echo e($icds->links('vendor.livewire.custom')); ?>
            ...
            <?php elseif($type == 'supporting_icd10'): ?>
                <div
                    class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 overflow-hidden mb-6">
                    <div class="table-container">
                        <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            <div class="flex items-center">
                                                <button
                                                    class="btn btn-icon text-blue-500 hover:text-blue-600 transition-colors edit-btn"
                                                    wire:click="choiceSupportingICD('<?php echo e($icd->id); ?>')">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                            </div>
                                        </td>
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-1 flex gap-4">
                            <button
                                class="<?php echo e($type_before_photo == 'upload' ? 'bg-blue-500 text-white' : 'bg-white-200 border border-blue-400'); ?> px-4 py-2 rounded-lg flex items-center gap-2"
                                wire:click="$set('type_before_photo', 'upload')">
                                <i class="fas fa-upload"></i>
                                <span>Upload</span>
                            </button>
                            <button
                                class="<?php echo e($type_before_photo == 'kamera' ? 'bg-blue-500 text-white' : 'bg-white-200 border border-blue-400'); ?> px-4 py-2 rounded-lg flex items-center gap-2"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type_before_photo == 'upload'): ?>
                        <div class="mb-3">
                    ...
                    <?php elseif($type_before_photo == 'kamera'): ?>
                        <div class="mb-3">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($before_photo): ?>
                        <div class="mt-2 flex items-start gap-3">
                            <img src="<?php echo e($before_photo->temporaryUrl()); ?>" class="object-cover rounded-lg"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['before_photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-1 flex gap-4">
                            <button
                                class="<?php echo e($type_after_photo == 'upload' ? 'bg-blue-500 text-white' : 'bg-white-200 border border-blue-400'); ?> px-4 py-2 rounded-lg flex items-center gap-2"
                                wire:click="$set('type_after_photo', 'upload')">
                                <i class="fas fa-upload"></i>
                                <span>Upload</span>
                            </button>
                            <button
                                class="<?php echo e($type_after_photo == 'kamera' ? 'bg-blue-500 text-white' : 'bg-white-200 border border-blue-400'); ?> px-4 py-2 rounded-lg flex items-center gap-2"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type_after_photo == 'upload'): ?>
                        <div class="mb-3">
                    ...
                    <?php elseif($type_after_photo == 'kamera'): ?>
                        <div class="mb-3">
                            <label class="block text-sm font-medium text-gray-700">Ambil Foto dengan Kamera</label>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($after_photo): ?>
                        <div class="mt-2 flex items-start gap-3">
                            <img src="<?php echo e($after_photo->temporaryUrl()); ?>" class="object-cover rounded-lg"
                                style="width: 300px; height: 300px;">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['after_photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
    ...
    <div
        ...
        <div class="px-6 py-4 text-gray-600">
            <div class="mb-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['name_how_to_use'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="mb-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['description_how_to_use'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="mb-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['time_how_to_use'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['day_how_to_use'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100"
                    ...
                    <div class="table-container">
                        <table class="table">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_5 = true; $__currentLoopData = $allergiMedicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $allergy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_5 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr>
                                        <td class="text-center"><?php echo e($index + 1); ?></td>
                                        <td><?php echo e($allergy->description); ?></td>
                                    </tr>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_5): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                    <tr>
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/consultation/consultation/detail/admin-consultation-consultation-detail-modal.blade.php ENDPATH**/ ?>