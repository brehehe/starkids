<div>
    <?php echo $__env->make('livewire.admin.logistic.good-come.admin-logistic-good-come-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <div class="mb-4">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($purchaseRequisition->purchaseOrder): ?>
                                    <?php echo e($purchaseRequisition->purchaseOrder->number ?? '-'); ?>

                                <?php else: ?>
                                    <a href="javascript:void(0)"
                                        wire:click="openCreatePO('<?php echo e($purchaseRequisition->id); ?>')"
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/logistic/good-come/admin-logistic-good-come-index.blade.php ENDPATH**/ ?>