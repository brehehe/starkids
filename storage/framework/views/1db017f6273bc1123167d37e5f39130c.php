...
<?php endif; ?>
            ...
            <div class="flex items-center justify-between border-t pt-4 mt-4">
                <div class="text-sm text-gray-500">
                    Menampilkan <?php echo e($products->firstItem()); ?> sampai <?php echo e($products->lastItem()); ?>

                    dari <?php echo e($products->total()); ?> data
                </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($is_pending_payment) && $is_pending_payment): ?>
            <div class="mb-4 p-3 bg-orange-50 border border-orange-200 rounded-lg flex items-center">
                <input id="is_down_payment" wire:model="is_down_payment" type="checkbox" class="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded cursor-pointer">
                <label for="is_down_payment" class="ml-2 block text-sm font-medium text-orange-800 cursor-pointer w-full">
                    Jadikan sebagai Down Payment (DP)
                </label>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/sale/pos/detail/admin-sale-pos-detail-modal.blade.php ENDPATH**/ ?>