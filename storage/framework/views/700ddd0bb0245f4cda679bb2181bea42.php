    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 overflow-hidden mb-6">
        <div class="table-container">
            <table class="table">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $transactionProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transactionProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            <td class="center">
                            ...
                            <td>
                                ...
                                <p class="text-xs text-gray-500"><?php echo e($transactionProduct->product->sku_number); ?></p>
                            </td>
                            <td><?php echo e($transactionProduct->product->productType->name); ?></td>
                            <td>Rp<?php echo e(number_format($transactionProduct->total_penjualan, 0, ',', '.')); ?></td>
                            <td>Rp<?php echo e(number_format($transactionProduct->total_hpp_total, 0, ',', '.')); ?></td>
                            <td><?php echo e($transactionProduct->total_quantity); ?></td>
                            <td>Rp<?php echo e(number_format($transactionProduct->total_profit, 0, ',', '.')); ?></td>
                            <td><?php echo e(number_format($transactionProduct->average_margin, 0, ',', '.')); ?>%</td>
                        </tr>
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/sale/report-profit-loss/admin-sale-report-profit-loss-index.blade.php ENDPATH**/ ?>