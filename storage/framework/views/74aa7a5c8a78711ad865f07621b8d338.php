<div>
    <?php echo $__env->make('livewire.admin.master.patient.admin-master-patient-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <div class="mb-4">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_5 = true; $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_5 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            ...
                            <td><?php echo e($patient?->companyRoles()?->where('company_id', Auth::user()->company_id)?->first()?->medical_record_number ?? '-'); ?>

                            </td>
                            <td><?php echo e($patient->userDetail->identity_card_display ?? '-'); ?></td>
                            <td>
                            ...
                            <td><?php echo e($patient?->userDetail?->birth_date ? Carbon\Carbon::parse($patient->userDetail->birth_date)->format('d F Y') : '-'); ?>

                            <td><?php echo e($patient?->phone ?? 0); ?></td>
                            <td class="center">
                                <div class="flex items-center">
                                    <button
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/master/patient/admin-master-patient-index.blade.php ENDPATH**/ ?>