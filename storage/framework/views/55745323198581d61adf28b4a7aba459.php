<?php
if (!function_exists('_55745323198581d61adf28b4a7aba459')):
function _55745323198581d61adf28b4a7aba459($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _c33b8aaf4ebde386d1712ae836ff58d3($__blaze, ['attributes' => $attributes], [], ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php
echo ltrim(ob_get_clean());
} endif; ?><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/vendor/livewire/flux/stubs/resources/views/flux/otp/input.blade.php ENDPATH**/ ?>