<div id="invoice">
    <div class="logo-section">
        ...
        <div class="store-info">
            ...
            <div class="store-info-line">Telp: <?php echo e(Auth::user()->company->phone); ?></div>
        </div>
    </div>
    <!-- Info Section -->
    ...
    <div class="transaction-section">
        ...
        <div class="transaction-list">
            <div class="transaction-item">
                ...
                <span class="item-total"><?php echo e(number_format($transactionService, 0, ',', '.')); ?></span>
            </div>
            <div class="transaction-item">
                <span class="item-name">Obat Obatan</span>
                <span
                    class="item-total"><?php echo e(number_format($transactionDetailNonService + $transactionRecipes, 0, ',', '.')); ?></span>
            </div>
        </div>
    </div>
...
<?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/print/invoice-total.blade.php ENDPATH**/ ?>