<?php
if (!function_exists('_41b32c1d9d0dc46e8f4226d1bec7aeb0')):
function _41b32c1d9d0dc46e8f4226d1bec7aeb0($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _1cb259fe6a7e5ee25397fd6182080d08($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => $iconClasses,'dataFluxBadgeIcon' => true], [], ['icon', 'variant', 'class', 'dataFluxBadgeIcon'], ['dataFluxBadgeIcon' => 'data-flux-badge-icon'], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
    ...
    <?php endif; ?>
<?php $__slotsf0cbb28d383530d3b657d632f6a4e797['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slotsf0cbb28d383530d3b657d632f6a4e797); ?>
<?php _f0cbb28d383530d3b657d632f6a4e797($__blaze, $__attrsf0cbb28d383530d3b657d632f6a4e797, $__slotsf0cbb28d383530d3b657d632f6a4e797, ['attributes', 'dataFluxBadge'], ['dataFluxBadge' => 'data-flux-badge'], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/vendor/livewire/flux/stubs/resources/views/flux/badge/index.blade.php ENDPATH**/ ?>