                ...
                <div
                    ...
                    <div class="p-5 md:p-8 bg-gradient-to-r from-blue-700 to-blue-600 shadow-inner">
                        <h2
                            ...
                            <?php echo e($queue['poly_name']); ?></h2>
                    </div>

                    <div class="p-6 md:p-10 flex flex-col items-center justify-between flex-grow space-y-8"
                        :class="{ 'ring-4 ring-blue-500 ring-inset animate-pulse': '<?php echo e($queue['status']); ?>' === 'call_consultation' }">
                        <div class="text-center group">
                            ...
                            <div
                                ...
                                <?php echo e($queue['current_queue']); ?>
                        ...
                        <div class="w-full">
                            ...
                            <div
                                ...
                                <span class="text-slate-200 font-bold text-sm md:text-base lg:text-lg truncate">dr.
                                    <?php echo e($queue['doctor_name']); ?></span>
                            </div>
                        </div>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($queue['status'] !== 'Kosong'): ?>
                        <div class="bg-blue-500/10 py-4 text-center border-t border-slate-700/30">
                            <span
                                ...
                                <?php echo e($queue['status'] === 'call_consultation' ? 'Panggilan Pasien' : 'SEDANG KONSULTASI'); ?>
        ...
        <div
            ...
            <div class="relative flex-grow overflow-hidden flex items-center py-4 bg-slate-900/20">
                <div
                    ...
                    sesuai • Terima kasih telah mempercayakan kesehatan Anda kepada kami • <?php echo e(config('app.name')); ?>
...
</style><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/queue/admin-queue-monitor-index.blade.php ENDPATH**/ ?>