...
<?php endif; ?>
                                        ...
                                        <td class="py-3 px-4 text-center w-1">
                                            <button class="text-blue-600 hover:text-blue-800 mx-1"
                                                wire:click="choiceProduct('<?php echo e($product->id); ?>')" title="Edit">
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/pharmacy/consultation/detail/admin-pharmacy-consultation-detail-modal.blade.php ENDPATH**/ ?>