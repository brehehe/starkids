...
<head>
    ...
    <title>Surat Rujukan - <?php echo e($transaction->code); ?></title>
    <style>
    ...
    <div class="container">
        ...
        <div class="content-section">
            <div class="row">
                ...
                <div class="colon">:</div>
                <div class="value">
                    <strong><?php echo e($reference->doctor_name ?? '-'); ?></strong><br>
                    di <?php echo e($reference->hospital ?? '-'); ?>
            ...
            <div class="row" style="margin-top: 15px;">
                ...
                <div class="colon">:</div>
                <div class="value"><?php echo e($reference->date_refer ? \Carbon\Carbon::parse($reference->date_refer)->format('d F Y') : '-'); ?></div>
            </div>
        </div>
        ...
        <div class="content-section">
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="colon">:</div>
                <div class="value"><?php echo e($transaction->patient->name ?? '-'); ?></div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="colon">:</div>
                <div class="value"><?php echo e($transaction->patient->userDetail->address ?? '-'); ?></div>
            </div>
        </div>
        ...
        <div class="content-section" style="margin-top: 20px;">
            <p class="text-justify">
                ...
                <?php echo nl2br(e($reference->description ?? '-')); ?>
        ...
        <div class="signature-area">
            <div class="signature-box">
                ...
                <div class="doctor-name"><?php echo e($transaction->doctor->name ?? '-'); ?></div>
                <div><?php echo e($transaction->doctor->userDetail->str ? 'STR: '.$transaction->doctor->userDetail->str : ''); ?></div>
            </div>
        </div>
    </div>
...
<?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/layout/receipt/referral.blade.php ENDPATH**/ ?>