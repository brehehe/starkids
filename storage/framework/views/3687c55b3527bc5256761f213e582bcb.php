<div wire:ignore.self id="modal"
    ...
    <div
        ...
        <div class="px-6 py-4 text-gray-600">
            <div class="mb-4">
                <label for="data_name" class="block text-sm font-medium text-gray-700">Nama Produk <span
                        class="text-red-600">*</span></label>
                <input type="text" id="data_name" wire:model.defer="data_name" placeholder="Masukkan nama produk"
                    disabled class="mt-1 form-control">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['data_name'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="mb-4">
                ...
                <div class="mt-1 flex rounded-md shadow-sm">
                    ...
                    <input disabled type="text" onkeyup="convertToRupiah(this);" id="hpp_average"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="mb-4">
                <label for="price" class="block text-sm font-medium text-gray-700">Harga Margin <span
                        class="text-red-600">*</span></label>
                <div class="mt-1 flex rounded-md shadow-sm">
                    <span
                        class="inline-flex items-center rounded-l-md border border-r-0 border-gray-300 bg-gray-100 px-3 text-gray-500 text-sm">
                    ...
                    <input type="text" onkeyup="convertToRupiah(this);" id="price" wire:model.defer="price"
                        placeholder="XXXXXXXXX" class="form-control rounded-l-none" />
                </div>
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/sale/product-price/admin-sale-product-price-modal.blade.php ENDPATH**/ ?>