            ...
            <div class="content">
                ...
                <div class="header">
                    ...
                    <div class="prescription-info">
                        <div class="prescription-number">No. <?php echo e($prescription['number']); ?></div>
                        <div>Tanggal: <?php echo e($prescription['date']); ?></div>
                        <div>Waktu: <?php echo e($prescription['time']); ?></div>
                        <div>Kode Konsultasi: <?php echo e($prescription['consultation_code']); ?></div>
                        <div style="color: #d32f2f; font-weight: bold;">COPY <?php echo e($prescription['date']); ?></div>
                    </div>
                </div>
                ...
                <div class="doctor-info">
                    <div class="doctor-card">
                        ...
                        <div class="doctor-details">
                            <div><strong><?php echo e($doctor['name']); ?></strong></div>
                            <div><?php echo e($doctor['specialization']); ?></div>
                            <div>SIP: <?php echo e($doctor['sip']); ?></div>
                            <div>STR: <?php echo e($doctor['str']); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="doctor-card">
                        ...
                        <div class="doctor-details">
                            <div><strong><?php echo e($location['name']); ?></strong></div>
                            <div><?php echo e($clinic['name']); ?></div>
                            <div><?php echo e($location['address']); ?></div>
                            <div>Telp: <?php echo e($location['phone']); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="patient-info">
                    ...
                    <div class="patient-details">
                        ...
                        <div class="patient-row">
                            ...
                            <div class="patient-colon">:</div>
                            <div class="patient-value"><?php echo e($patient['age']); ?></div>
                        </div>
                        <div class="patient-row">
                            <div class="patient-label">Jenis Kelamin</div>
                            <div class="patient-colon">:</div>
                            <div class="patient-value"><?php echo e($patient['gender']); ?></div>
                        </div>
                        <div class="patient-row">
                            <div class="patient-label">Alamat</div>
                            <div class="patient-colon">:</div>
                            <div class="patient-value"><?php echo e($patient['address']); ?></div>
                        </div>
                        <div class="patient-row">
                            <div class="patient-label">No. Telepon</div>
                            <div class="patient-colon">:</div>
                            <div class="patient-value"><?php echo e($patient['phone']); ?></div>
                        </div>
                        <div class="patient-row">
                            <div class="patient-label">Diagnosis</div>
                            <div class="patient-colon">:</div>
                            <div class="patient-value"><?php echo e($patient['diagnosis']); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <table class="prescription-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $medicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                <td class="no-col"><?php echo e($medicine['no']); ?></td>
                                <td class="medicine-col">
                                    <div class="medicine-name"><?php echo e($medicine['name']); ?></div>
                                    <div class="medicine-details"><?php echo e($medicine['details']); ?></div>
                                </td>
                                <td class="dosage-col">
                                    <div class="dosage-info"><?php echo e($medicine['dosage']); ?></div>
                                </td>
                                <td class="quantity-col"><?php echo e($medicine['quantity']); ?></td>
                                <td class="instruction-col">
                                    <div class="instruction-text">
                                        <?php echo e($medicine['instruction']); ?>
                ...
                <div class="bottom-section">
                    <div class="signature-section">
                        <div class="signature-location"><?php echo e($location['name']); ?>, <?php echo e(date('d F Y')); ?></div>
                        <div class="signature-title">Dokter Pemeriksa</div>
                        <div class="signature-line"></div>
                        <div class="signature-name"><?php echo e($doctor['name']); ?></div>
                        <div class="signature-position"><?php echo e($doctor['specialization']); ?></div>
                        <div class="signature-license">SIP: <?php echo e($doctor['sip']); ?></div>
                    </div>
                    ...
                    <div class="signature-section">
                        ...
                        <div class="signature-line"></div>
                        <div class="signature-name"><?php echo e($pharmacist['name']); ?></div>
                        <div class="signature-position"><?php echo e($pharmacist['position']); ?></div>
                        <div class="signature-license">SIA: <?php echo e($pharmacist['license']); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/layout/receipt/prescription-copy.blade.php ENDPATH**/ ?>