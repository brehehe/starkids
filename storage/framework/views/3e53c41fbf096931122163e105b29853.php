...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <head>
        ...
        <title><?php echo e(config('app.name', 'Klinik Sehat Mandiri')); ?></title>
        ...
        <meta property="og:title" content="<?php echo e(config('app.name')); ?> - Kesehatan Terpercaya">
        <meta property="og:description"
            content="Pelayanan kesehatan terbaik dengan teknologi modern dan tenaga medis berpengalaman">
        <meta property="og:image" content="<?php echo e(asset('img/og-image.jpg')); ?>">
...
<?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/layout/user/app.blade.php ENDPATH**/ ?>