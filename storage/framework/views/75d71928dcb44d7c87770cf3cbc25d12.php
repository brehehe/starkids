    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 overflow-hidden mb-6">
        <div class="table-container">
            <table class="table">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_5 = true; $__currentLoopData = $product_packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product_package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_5 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            ...
                            <td>
                                <div <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'select-'.e(rand()).''; ?>wire:key="select-<?php echo e(rand()); ?>">
                                    <select class="mt-1 form-control" x-data x-ref="input" x-init="$($refs.input).selectize({
                                        ...
                                        onChange: function(e) {
                                            window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('product_packages.<?php echo e($index); ?>.product_id', e ? e : null)
                                        }
                                    });"
                                        wire:model.live="product_packages.<?php echo e($index); ?>.product_id"
                                        id="product_packages.<?php echo e($index); ?>.product_id">
                            ...
                            <td><input type="number" wire:model.lazy="product_packages.<?php echo e($index); ?>.quantity"
                                    class="mt-1 form-control" placeholder="Masukkan Jumlah" /></td>
                            <td>Rp<?php echo e(number_format($product_package['hpp_average'] ?? 0, 0, ',', '.')); ?></td>
                            <td>Rp<?php echo e(number_format($product_package['price'] ?? 0, 0, ',', '.')); ?></td>
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/master/product/package/admin-master-product-package-data.blade.php ENDPATH**/ ?>