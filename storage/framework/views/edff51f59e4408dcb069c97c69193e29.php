...
<?php endif; ?>
<?php $component->withAttributes(['icon' => $icon,'internal' => true,'class' => \Illuminate\Support\Arr::toCssClasses(['mr-1' => $position === 'left', $personalize['icon'], $colors['icon']])]); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\DynamicComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => $icon,'internal' => true,'class' => \Illuminate\Support\Arr::toCssClasses(['ml-1' => $position === 'right', $personalize['icon'], $colors['icon']])]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/vendor/tallstackui/tallstackui/src/resources/views/components/badge.blade.php ENDPATH**/ ?>