<?php
if (!function_exists('_74c497c1f631f4fe7d0b41ba0cad34b6')):
function _74c497c1f631f4fe7d0b41ba0cad34b6($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<div class="<?php echo e($containerClasses); ?>">
    ...
    <?php if ($paginate): ?>
        ...
        <?php $__blaze->ensureRequired('/Users/macbookair/Documents/mediction/mediction.id/vendor/livewire/flux/src/../stubs/resources/views/flux/pagination.blade.php', $__blaze->compiledPath.'/470cfa107c996147ac774cdd120e60e0.php'); ?>
<?php $__blaze->pushData(['attributes' => $paginationAttributes]); ?>
<?php _470cfa107c996147ac774cdd120e60e0($__blaze, ['attributes' => $paginationAttributes], [], ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php endif; ?>
</div>
<?php
echo ltrim(ob_get_clean());
} endif; ?><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/vendor/livewire/flux/stubs/resources/views/flux/table/index.blade.php ENDPATH**/ ?>