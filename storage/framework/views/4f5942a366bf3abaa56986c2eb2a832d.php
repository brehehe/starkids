                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($promotion->applicable_products): ?>
                                        <span class="text-blue-600"><?php echo e(count($promotion->applicable_products)); ?>

                                            Produk</span>
                                    <?php elseif($promotion->applicable_users): ?>
                                        <span class="text-green-600"><?php echo e(count($promotion->applicable_users)); ?>

                                            User</span>
                                    <?php elseif($promotion->applicable_user_types): ?>
                                        <span class="text-purple-600"><?php echo e(count($promotion->applicable_user_types)); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    ...
                                    <a href="<?php echo e(route('promotions.detail')); ?>?id=<?php echo e($promotion->id); ?>"
                                        class="text-green-600 hover:text-green-900" title="Detail">
                                        <i class="fas fa-eye"></i>
                                    </a>

                                    
                                    <button wire:click="delete('<?php echo e($promotion->id); ?>')"
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                <div class="text-gray-500">
                                    ...
                                    <a href="<?php echo e(route('promotions.create')); ?>" class="btn btn-primary mt-4">
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/master/promotion/admin-master-promotion-index.blade.php ENDPATH**/ ?>