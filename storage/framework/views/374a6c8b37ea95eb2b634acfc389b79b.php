...
<div x-data="tallstackui_layout()" x-on:tallstackui-menu-mobile.window="tallStackUiMenuMobile = $event.detail.status">
    ...
    <div class="<?php echo e($personalize['wrapper.first']); ?>">
        <div x-bind:class="{ '<?php echo e($personalize['wrapper.second.expanded']); ?>' : $store['tsui.side-bar'].open, '<?php echo e($personalize['wrapper.second.collapsed']); ?>' : !$store['tsui.side-bar'].open }">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($header): ?>
                <?php echo e($header); ?>

            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <main class="<?php echo e($personalize['main']); ?>">
                <?php echo e($slot); ?>
...
<?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/vendor/tallstackui/tallstackui/src/resources/views/components/layout/layout.blade.php ENDPATH**/ ?>