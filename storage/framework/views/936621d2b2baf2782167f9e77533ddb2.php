            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" placeholder="Contoh: SKU12345"
                        value="<?php echo e($purchase_order_item?->product?->name); ?>" disabled class="mt-1 form-control" />
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">SKU Number</label>
                    <input type="text" placeholder="Contoh: SKU12345"
                        value="<?php echo e($purchase_order_item?->product?->sku_number); ?>" disabled class="mt-1 form-control" />
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Jumlah Dipesan</label>
                    <div class="mt-1 flex rounded-md shadow-sm">
                        <input type="text" value="<?php echo e($purchase_order_item?->quantity); ?>" disabled
                        ...
                        <span
                            ...
                            <?php echo e($purchase_order_item?->productUnit?->unit?->name); ?>
                ...
                <div class="border-end">
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <input type="text"
                                    value="<?php echo e($quantity_arrival + $purchase_order_item?->quantity_accepted); ?>" disabled
                                    class="form-control rounded-r-none" placeholder="XXXXXXXXX" />
                                <span
                                    class="inline-flex items-center rounded-r-md border border-r-0 border-gray-300 bg-gray-100 px-3 text-gray-500 text-sm">
                                    <?php echo e($purchase_order_item?->productUnit?->unit?->name); ?>
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <input type="text"
                                    value="<?php echo e($quantity_arrival - $purchase_order_item?->quantity_less); ?>" disabled
                                    class="form-control rounded-r-none" placeholder="XXXXXXXXX" />
                                <span
                                    class="inline-flex items-center rounded-r-md border border-r-0 border-gray-300 bg-gray-100 px-3 text-gray-500 text-sm">
                                    <?php echo e($purchase_order_item?->productUnit?->unit?->name); ?>
                ...
                <div class="md:col-span-2">
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                        <div>
                            ...
                            <button wire:click="addBatchNumber()" <?php echo e($quantity_arrival ? '' : 'disabled'); ?>

                                class="mt-1 block w-full px-4 py-2 text-sm h-10 font-semibold text-white <?php echo e($quantity_arrival ? 'btn-yellow-500 hover:btn-yellow-500' : 'btn-secondary-500 hover:btn-secondary-500'); ?> rounded-lg transition">
                                Tambah Expired Date
                            </button>
                        </div>
                        <div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $batch_numbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_batch_number => $batch_number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="grid grid-cols-3 md:grid-cols-3 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input type="date"
                                            wire:model.live="batch_numbers.<?php echo e($key_batch_number); ?>.expired_date"
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            <input type="text"
                                                wire:model.live="batch_numbers.<?php echo e($key_batch_number); ?>.stok"
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            <input type="text"
                                                wire:model.live="batch_numbers.<?php echo e($key_batch_number); ?>.batch_number"
                                                placeholder="Masukan Batch Number"
                                                class="block w-full rounded-l-md border-gray-300 px-4 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500" />
                                            <button wire:click="deleteBatchNumber('<?php echo e($key_batch_number); ?>')"
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/logistic/good-come/detail/admin-logistic-good-come-detail-modal.blade.php ENDPATH**/ ?>