    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 overflow-hidden mb-6">
        <div class="table-container">
            <table class="table">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $transaction_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_transaction_detail => $transaction_detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="border-b bg-blue-50">
                            <td class="py-2">
                                <p class="font-medium"><?php echo e($transaction_detail['product_name']); ?></p>
                                <p class="text-xs text-gray-500">
                                    @Rp<?php echo e(number_format($transaction_detail['price'], 0, ',', '.')); ?></p>
                            </td>
                            <td class="py-2 text-center">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($status, ['sale_pharmacy'])): ?>
                                    <input type="number"
                                        ...
                                        style="width: 100%;">
                                <?php else: ?>
                                    <span class="text-sm"><?php echo e($transaction_detail['quantity']); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td class="py-2 text-right">
                                Rp<?php echo e(number_format($transaction_detail['sub_total_price'], 0, ',', '.')); ?></td>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($status, ['sale_pharmacy'])): ?>
                                <td>
                                    <button wire:click="confirmDeleteMedicine('<?php echo e($transaction_detail['id']); ?>')"
...
</div><?php /**PATH /Users/macbookair/Documents/mediction/mediction.id/resources/views/livewire/admin/pharmacy/sale/detail/admin-pharmacy-sale-detail-index.blade.php ENDPATH**/ ?>