...
Route::group(['namespace' => 'App\Livewire\Admin', 'prefix' => 'user', 'middleware' => ['auth', 'verified']], function () {
    ...
    Route::group(['namespace' => 'Hr', 'prefix' => 'hr'], function () {
        ...
        Route::prefix('payroll')->group(function () {
            Route::get('/adjustment', \App\Livewire\Admin\Hr\Payroll\AdminHrPayrollAdjustmentIndex::class)->name('user.hr.payroll.adjustment');
            Route::get('/generate', \App\Livewire\Admin\Hr\Payroll\AdminHrPayrollGenerateIndex::class)->name('user.hr.payroll.generate');
        });
    });
    ...
    Route::group(['namespace' => 'Consultation', 'prefix' => 'consultation'], function () {
        ...
        // Print Routes
        Route::get('/referral/print/{transaction_id}', [\App\Http\Controllers\Admin\Consultation\ConsultationPrintController::class, 'printReferral'])->name('user.consultation.referral.print');
        Route::get('/consent/print/{transaction_id}', [\App\Http\Controllers\Admin\Consultation\ConsultationPrintController::class, 'printConsent'])->name('user.consultation.consent.print');
    });
    ...
    Route::group(['prefix' => 'prescription'], function () {
        Route::get('/', [\App\Http\Controllers\Admin\Prescription\PrescriptionController::class, 'index'])->name('user.prescription.index');
        Route::get('/view/{transaction_id}', [\App\Http\Controllers\Admin\Prescription\PrescriptionController::class, 'show'])->name('user.prescription.show');
        Route::get('/copy/{transaction_id}', [\App\Http\Controllers\Admin\Prescription\PrescriptionController::class, 'showCopy'])->name('user.prescription.copy');
        Route::get('/print/{transaction_id}', [\App\Http\Controllers\Admin\Prescription\PrescriptionController::class, 'print'])->name('user.prescription.print');
        Route::get('/print-copy/{transaction_id}', [\App\Http\Controllers\Admin\Prescription\PrescriptionController::class, 'printCopy'])->name('user.prescription.print-copy');
    });
    ...
    Route::group(['namespace' => 'Logistic', 'prefix' => 'logistic'], function () {
        ...
        Route::get('/product-adjustment', \App\Livewire\Admin\Logistic\ProductAdjustment\AdminLogisticProductAdjustmentIndex::class)->name('user.logistic.product-adjustment');
    ...
    Route::group(['prefix' => 'import'], function () {
        Route::post('/replace-product', [App\Http\Controllers\Import\ReplaceProductImportController::class, 'import'])->name('user.import.replace-product');
        Route::get('/replace-product/progress/{key}', [App\Http\Controllers\Import\ReplaceProductImportController::class, 'getProgress'])->name('user.import.replace-product.progress');
    });
    ...
    Route::group(['prefix' => 'family'], function () {
        Route::get('/', \App\Livewire\Admin\Family\AdminFamilyIndex::class)->name('user.family.index');
    });
    ...
    Route::prefix('notifications')->group(function () {
        Route::get('/', [\App\Http\Controllers\NotificationController::class, 'index'])->name('user.notifications.index');
        Route::get('/list', \App\Livewire\Admin\Notification\AdminNotificationIndex::class)->name('user.notifications.list'); // New Route
        Route::post('/{id}/read', [\App\Http\Controllers\NotificationController::class, 'markAsRead'])->name('user.notifications.read');
        Route::post('/mark-all-read', [\App\Http\Controllers\NotificationController::class, 'markAllAsRead'])->name('user.notifications.mark-all-read');
    });
...
Route::prefix('admin')->group(function () {
    ...
    Route::post('/panggil-berikutnya', [\App\Http\Controllers\AdminController::class, 'callNext'])->name('admin.call-next');
    Route::patch('/antrian/{id}/status', [\App\Http\Controllers\AdminController::class, 'updateStatus'])->name('admin.update-status');
});

// RAHMIE
Route::prefix('/prototype/antrian')->group(function () {
    Route::get('/', [\App\Http\Controllers\QueueController::class, 'index'])->name('queue.index');
    Route::get('/daftar', [\App\Http\Controllers\QueueController::class, 'create'])->name('queue.create');
    Route::post('/', [\App\Http\Controllers\QueueController::class, 'store'])->name('queue.store');
    Route::get('/data', [\App\Http\Controllers\QueueController::class, 'getQueueData'])->name('queue.data');
});

Route::prefix('/antrian')->group(function () {
    Route::get('/', QueueIndex::class)->name('queue');
    Route::get('/daftar', QueueRegister::class)->name('queue.register');
    Route::get('/monitor', \App\Livewire\Admin\Queue\AdminQueueMonitorIndex::class)->name('queue.monitor');
});

Route::get('/print/invoice/{id}', [\App\Http\Controllers\Print\PrintController::class, 'invoice'])->name('print.invoice');
Route::get('/print/invoice-total/{id}', [\App\Http\Controllers\Print\PrintController::class, 'invoiceTotal'])->name('print.invoice-total');

Route::get('/print/invoice-sale', [\App\Http\Controllers\Print\PrintControllerNew::class, 'invoiceSale'])->name('print.invoice.sale');

Route::get('/print/invoice-print', [\App\Http\Controllers\Print\PrintControllerNew::class, 'invoicePrint'])->name('print.invoice.print');
...
Route::post('/proxy/select', function (\Illuminate\Http\Request $request) {
