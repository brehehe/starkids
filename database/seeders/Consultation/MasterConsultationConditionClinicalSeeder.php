...
use App\Models\Master\CodeSystem\Consultation\MasterConsultationConditionClinical;
use Illuminate\Database\Console\Seeds\WithoutModelEvents;
use Illuminate\Database\Seeder;

class MasterConsultationConditionClinicalSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        foreach ($data as $item) {
            MasterConsultationConditionClinical::updateOrCreate(
                ['code' => $item['code']],
                $item
            );
        }
