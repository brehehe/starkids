...
class CodeChiefComplaint extends Seeder
{
    /**
    ...
    public function run(): void
    {
        //
        // Ambil isi file JSON
        $json = File::get(database_path('seeders/CodeSystem/Files/Condition/CodeSystem-condition-code-chief-complaint.json'));
        ...
        foreach ($datas as $key => $value) {
            ...
            MasterConditionCodeChiefComplaint::create([
