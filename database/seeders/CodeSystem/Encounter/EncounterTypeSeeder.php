...
use App\Models\Master\CodeSystem\Encounter\EncounterType;
use App\Models\Master\CodeSystem\Encounter\MasterEncounterType;
use Carbon\Carbon;
...
class EncounterTypeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        //
        // Ambil isi file JSON
        $json = File::get(database_path('seeders/CodeSystem/Files/Encounter/CodeSystem-encounter-type.json'));
