...
use App\Models\Master\CodeSystem\Encounter\MasterEncounterIdentifierUse;
...
class IdentifierUseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        //
        // Ambil isi file JSON
        $json = File::get(database_path('seeders/CodeSystem/Files/Encounter/CodeSystem-identifier-use.json'));
        ...
        foreach ($datas as $key => $value) {
            ...
            MasterEncounterIdentifierUse::create([
