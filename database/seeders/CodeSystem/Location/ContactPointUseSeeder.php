...
use App\Models\Master\CodeSystem\Location\MasterLocationContactPointUse;
use Illuminate\Database\Console\Seeds\WithoutModelEvents;
use Illuminate\Database\Seeder;
use Illuminate\Support\Facades\File;

class ContactPointUseSeeder extends Seeder
{
    /**
    ...
    {
        //
        $json = File::get(database_path('seeders/CodeSystem/Files/Location/CodeSystem-contact-point-use.json'));

        $datas = isset(json_decode($json, true)['concept']) ? json_decode($json, true)['concept'] : [];

        foreach ($datas as $key => $value) {

        MasterLocationContactPointUse::create([
