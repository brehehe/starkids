...
return new class extends Migration
{
    ...
    {
        Schema::create('one_health_medication_request_dosage_instructions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('one_health_medication_request_dosage_instructions');
    }
};
