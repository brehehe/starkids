...
return new class extends Migration
{
    ...
    {
        Schema::create('encounter_support_conditions', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->foreignUuid('encounter_id');
            $table->foreignUuid('transaction_id')->nullable();
            $table->foreignUuid('transaction_secondary_id')->nullable();
    ...
    {
        Schema::dropIfExists('encounter_support_conditions');
    }
};
