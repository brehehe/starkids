...
return new class extends Migration
{
    ...
    {
        Schema::create('stock_opname_item_details', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->foreignUuid('stock_opname_id');
            $table->foreignUuid('stock_opname_item_id');
            ...
            // Tidak wajib jika quantity_difference sudah cukup
            // Hapus jika tidak ada logika khusus
            // $table->bigInteger('quantity_difference_system')->default(0);
    ...
    {
        Schema::dropIfExists('stock_opname_item_details');
    }
};
