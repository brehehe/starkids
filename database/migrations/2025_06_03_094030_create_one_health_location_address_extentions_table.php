...
return new class extends Migration
{
    ...
    {
        Schema::create('one_health_location_address_extentions', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->foreignUuid('one_health_location_address_id')->nullable();
    ...
    {
        Schema::dropIfExists('one_health_location_address_extentions');
    }
};
