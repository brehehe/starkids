...
class ObservationService
{
    ...
    private function postObservation($request, $OHObservation)
    {
        ...
        if (config('app.name') != 'production') Log::info('Successfully OneHealth_ObservationService->postObservation', $responseBody);
    ...
    private function putObservation($request, $OHObservation)
    {
        ...
        if (config('app.name') != 'production') Log::info('Successfully OneHealth_ObservationService->putObservation', $responseBody);
