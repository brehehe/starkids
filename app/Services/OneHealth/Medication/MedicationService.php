...
class MedicationService
{
    ...
    public function getProductDetailV2($request)
    {
        ...
        if (config('app.name') != 'production') {
            Log::info('Successfully OneHealth_MedicationService->getProductDetailV2', $responseBody);
        }
    ...
    private function postMedication($OHMedication, $request)
    {
        ...
        if (config('app.name') != 'production') {
            Log::info('Successfully OneHealth_MedicationService->postMedication', $responseBody);
        }
    ...
    private function putMedication($OHMedication, $request)
    {
        ...
        if (config('app.name') != 'production') {
            Log::info('Successfully OneHealth_MedicationService->putMedication', $responseBody);
        }
