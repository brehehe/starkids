...
class OrganizationService
{
    ...
    private function postOrganization($OHOrganization, $request)
    {
        ...
        if (config('app.name') != 'production') {
            Log::info('Successfully OneHealth_OrganizationService->postOrganization', $responseBody);
        }
    ...
    private function putOrganization($OHOrganization, $request)
    {
        ...
        if (config('app.name') != 'production') {
            Log::info('Successfully OneHealth_OrganizationService->putOrganization', $responseBody);
        }
    ...
    public function getOrganization($company)
    {
        ...
        if (config('app.name') != 'production') {
            Log::info('Successfully OneHealth_OrganizationService->getOrganization', $responseBody);
        }
    ...
    public function getOrganizationId($company, $param)
    {
        ...
        if (config('app.name') != 'production') {
            Log::info('Successfully OneHealth_OrganizationService->getOrganizationId', $responseBody);
        }
