...
class MedicationRequestService
{
    ...
    private function postMedicationRequest($request, $OHMedicationReq)
    {
        ...
        if (config('app.name') != 'production') {
            Log::info('Successfully OneHealth_MedicationRequestService->postMedicationRequest', $responseBody);
        }
    ...
    private function putMedicationRequest($request, $OHMedicationReq)
    {
        ...
        if (config('app.name') != 'production') {
            Log::info('Successfully OneHealth_MedicationRequestService->putMedicationRequest', $responseBody);
        }
