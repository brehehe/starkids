...
class AdminLogisticStockInIndex extends Component
{
    use ProductStockTrait, ProductTrait, WithPagination;
    ...
    {
        return view('livewire.admin.logistic.stock-in.admin-logistic-stock-in-index',
            [
