...
{
    use ProductStockTrait, WithPagination, WithFileUploads;
    ...
    public function openUpdateStockModal($productId)
    {
        ...
        $product = \App\Models\Product\Product::with(['productStock'])->find($productId);
    ...
    public function updateStock()
    {
        ...
        try {
            ...
            $product = \App\Models\Product\Product::with(['productStock'])->find($this->selectedProductId);
            ...
            if ($product->productStock) {
                ...
                \App\Models\Product\ProductStock::create([
