...
class AdminLogisticGoodComeDetailIndex extends Component
{
    ...
    public $purchase_order_id, $purchase_order_item_id, $purchase_order_item, $quantity_arrival, $hna, $hna_ppn, $price, $sub_total, $getQuantityAccepted, $ppn, $total;
    public $hna_old, $hna_ppn_old, $price_old, $quantity_detail, $ppn_old, $discount, $discount_type, $discount_value;
