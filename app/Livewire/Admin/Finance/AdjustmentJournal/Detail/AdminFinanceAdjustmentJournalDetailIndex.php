...
namespace App\Livewire\Admin\Finance\AdjustmentJournal\Detail;
...
class AdminFinanceAdjustmentJournalDetailIndex extends Component
{
    public $journal_id;
    public $date;
    public $description;
    ...
    public function save()
    {
        ...
        // No balance validation for adjustment journal - can be unbalanced
        ...
        try {
            \DB::transaction(function () {
                if ($this->journal_id) {
                    ...
                    // Create new journal
                    $finance = \App\Models\Finance\Finance::where('company_id', auth()->user()->company_id)
                        ->whereDate('date', $this->date)
                        ->first();

                    if (!$finance) {
                        $finance = \App\Models\Finance\Finance::create([
            ...
            AlertHelper::success('Berhasil','Jurnal penyesuaian berhasil disimpan');
            return redirect()->route('user.finance.adjustment-journal');
        } catch (\Exception $e) {
    ...
    {
        return view('livewire.admin.finance.adjustment-journal.detail.admin-finance-adjustment-journal-detail-index', [
