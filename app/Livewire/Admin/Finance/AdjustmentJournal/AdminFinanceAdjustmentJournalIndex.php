...
namespace App\Livewire\Admin\Finance\AdjustmentJournal;
...
class AdminFinanceAdjustmentJournalIndex extends Component
{
    use WithPagination;
    ...
    public function delete($id)
    {
        try {
            ...
            $this->dispatch('success', message: 'Jurnal penyesuaian berhasil dihapus');
        } catch (\Exception $e) {
    ...
    {
        return view('livewire.admin.finance.adjustment-journal.admin-finance-adjustment-journal-index', [
