...
namespace App\Livewire\Admin\Hr\Doctor;
...
class AdminHrDoctorIndex extends Component
{
    use CompanyTrait, RegionTrait, WithFileUploads, WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.hr.doctor.admin-hr-doctor-index', [
            'users' => $users,
        ])
            ->extends('layout.app')
            ->section('content');
