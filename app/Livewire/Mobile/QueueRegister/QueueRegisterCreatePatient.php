...
{
    use RegionTrait, AuthenticateTrait;
    ...
    public $name, $identity_card, $email, $phone, $birth_date, $age, $family_status, $marital_status, $administrative_gender, $blood_group;
    public $province_code, $city_code, $district_code, $sub_district_code;
    public $address, $postal_code, $rt_code, $rw_code;
