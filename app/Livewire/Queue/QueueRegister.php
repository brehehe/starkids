...
{
    use RegionTrait;
    public $step = 1, $progress_bar = 20, $open_form = true;
    public $company_items = [], $poli_items = [], $doctors = [], $time_slots = [];
    public $company, $poli, $selected_doctor, $visit_date, $days, $selected_time;
    ...
    // patient
    public $data_id, $user_id, $name, $identity_card, $identity_card_mother = false, $email, $phone, $province_code, $city_code, $district_code, $sub_district_code, $address, $postal_code, $rt_code, $rw_code, $blood_group, $marital_status, $birth_date, $patient_complaint, $administrative_gender, $user_type_id;
