...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany(UserControlSchedule::class, 'user_id');
    }
    ...
    {
        return $this->hasOne(EmployeePayroll::class, 'user_id');
    }
    ...
    {
        return $this->hasMany(PatientReferralIncentive::class, 'referrer_id');
    }
    ...
    {
        return $this->hasOne(PatientReferralIncentive::class, 'referred_id');
    }
}
