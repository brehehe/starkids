...
class Transaction extends Model
{
    ...
    {
        return $this->hasMany(\App\Models\TransactionInstallment::class);
    }
    ...
    {
        return $this->belongsTo(\App\Models\Deposit\Deposit::class, 'deposit_id');
    }
    ...
    public function updatePatientReferralIncentive($modelUpdate)
    {
        ...
        $existingIncentive = \App\Models\Patient\PatientReferralIncentive::where('referred_id', $modelUpdate->patient_id)->exists();
        ...
        $userTypeIncentive = \App\Models\User\UserTypeIncentive::findIncentiveForUserType(
            $referralUserTypeId,
            $grandTotalPrice,
        ...
        try {
            $result = \App\Models\Patient\PatientReferralIncentive::updateOrCreate(
                [
