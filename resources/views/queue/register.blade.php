...
<body class="h-full bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800">
    <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
                    ...
                    <div id="step3" class="step hidden animate-fade-in">
                        ...
                        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-6 mb-6">
                            <div class="mb-6">
                                ...
                                <input type="date" id="visit_date" name="visit_date" class="w-full px-4 py-3 border-2 border-gray-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-700 dark:text-white transition-all duration-300 hover:border-blue-300" min="{{ date('Y-m-d') }}">
                            </div>
        ...
        <div class="mt-8 text-center">
            <a href="{{ route('queue.index') }}" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-medium">
