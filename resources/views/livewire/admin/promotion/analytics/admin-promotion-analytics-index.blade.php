            ...
            <div class="py-6">
                <div class="md:flex md:items-center md:justify-between">
                    ...
                    <div class="mt-4 flex md:mt-0 md:ml-4 space-x-3">
                        ...
                        <a href="{{ route('user.master.promotion.create') }}"
        ...
        @if ($analytics)
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">
                                    {{ $analytics['overview']['total_promotions'] ?? 0 }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">
                                    {{ number_format($analytics['overview']['total_usage'] ?? 0) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">Rp
                                    {{ number_format($analytics['overview']['total_revenue'] ?? 0, 0, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">Rp
                                    {{ number_format($analytics['overview']['total_savings'] ?? 0, 0, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div class="bg-white shadow-sm rounded-lg">
                    ...
                    <div class="p-6">
                        @if (isset($analytics['revenue_impact']['revenue_by_type']) &&
                                count($analytics['revenue_impact']['revenue_by_type']) > 0)
                            <div class="space-y-3">
                                @foreach ($analytics['revenue_impact']['revenue_by_type'] as $type => $revenue)
                                    <div class="flex items-center justify-between">
                                        <span
                                            class="text-sm font-medium text-gray-900">{{ ucfirst(str_replace('_', ' ', $type)) }}</span>
                                        <span class="text-sm text-gray-500">Rp
                                            {{ number_format($revenue, 0, ',', '.') }}</span>
                                    </div>
                                @endforeach
                            </div>
                        @else
                ...
                <div class="bg-white shadow-sm rounded-lg">
                    ...
                    <div class="p-6">
                        @if (isset($analytics['customer_engagement']))
                            <div class="space-y-4">
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-500">Unique Customers</span>
                                    <span
                                        class="font-medium">{{ number_format($analytics['customer_engagement']['unique_customers'] ?? 0) }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-500">Repeat Customers</span>
                                    <span
                                        class="font-medium">{{ number_format($analytics['customer_engagement']['repeat_customers'] ?? 0) }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-500">Retention Rate</span>
                                    <span
                                        class="font-medium">{{ $analytics['customer_engagement']['customer_retention_rate'] ?? 0 }}%</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-500">Avg Promotions per Customer</span>
                                    <span
                                        class="font-medium">{{ $analytics['customer_engagement']['average_promotions_per_customer'] ?? 0 }}</span>
                                </div>
                            </div>
                        @else
                            <div class="text-center py-8 text-gray-500">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white shadow-sm rounded-lg">
                    ...
                    <div class="overflow-hidden">
                        @if (isset($analytics['revenue_impact']['roi_by_promotion']) &&
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach (array_slice($analytics['revenue_impact']['roi_by_promotion'], 0, 5) as $promo)
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                                {{ $promo['promotion_name'] ?? 'Unknown' }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                Rp {{ number_format($promo['revenue'] ?? 0, 0, ',', '.') }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span
                                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                            {{ ($promo['roi_percentage'] ?? 0) > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                                    {{ $promo['roi_percentage'] ?? 0 }}%
                                                </span>
                                            </td>
                                        </tr>
                                    @endforeach
                ...
                <div class="bg-white shadow-sm rounded-lg">
                    ...
                    <div class="p-6">
                        @if (isset($analytics['customer_engagement']['customer_segments']))
                            <div class="space-y-4">
                                @php $segments = $analytics['customer_engagement']['customer_segments']; @endphp

                                <div class="flex justify-between items-center">
                                    <span class="text-sm text-gray-500">High Value</span>
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                        {{ $segments['high_value'] ?? 0 }} customers
                                    </span>
                                </div>
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        ...
                                        {{ $segments['medium_value'] ?? 0 }} customers
                                    </span>
                                </div>
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        ...
                                        {{ $segments['low_value'] ?? 0 }} customers
                                    </span>
                                </div>
                            </div>
                        @else
