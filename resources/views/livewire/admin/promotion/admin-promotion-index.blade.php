    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('user.promotion.create') }}" class="btn btn-primary">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    ...
                                    @if (!empty($applicableCompanies))
                                        <span class="text-orange-600">{{ count($applicableCompanies) }}
                                            Company</span>
                                    @elseif (!empty($applicableProducts))
                                        <span class="text-blue-600">{{ count($applicableProducts) }}
                                            Produk</span>
                                    @elseif (!empty($applicableUsers))
                                        <span class="text-green-600">{{ count($applicableUsers) }}
                                            User</span>
                                    @elseif (!empty($applicableUserTypes))
                                        <span class="text-purple-600">{{ count($applicableUserTypes) }}
                                            Tipe User</span>
                                    @else
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                <div class="text-gray-500">
                                    ...
                                    <a href="{{ route('user.promotion.create') }}" class="btn btn-primary mt-4">
