<div>
    <div class="mb-4">
        <div class="flex items-center justify-between">
            ...
            <div>
                <a href="{{ route('user.finance.general-journal.detail') }}" class="btn btn-primary">
                        ...
                        <div class="flex-1 grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div class="flex items-center space-x-3">
                                <div class="flex-shrink-0 w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center">
                                    <span class="text-blue-600 font-bold text-sm">{{ $journals->firstItem() + $index }}</span>
                                </div>
                                <div>
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div class="flex gap-2">
                                <a href="{{ route('user.finance.general-journal.detail', ['id' => $journal->id]) }}" class="btn btn-sm btn-warning">
