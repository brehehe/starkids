<div>
    <div class="mb-4">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-[#1E3A8A]">{{ $journal_id ? 'Edit' : 'Tambah' }} Jurnal Penyesuaian</h1>
            </div>
            <div>
                <a href="{{ route('user.finance.adjustment-journal') }}" class="btn btn-secondary">
