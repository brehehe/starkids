            ...
            <table class="table">
                ...
                <tbody>
                    @forelse ($transactions as $index => $transaction)
                        <tr
                            class="hover:bg-green-50 {{ in_array($transaction->status, ['draft_consultation', 'call_consultation', 'confirmation_call', 'consultation']) ? '' : ($transaction->status == 'canceled' ? 'bg-red-100' : 'bg-green-100') }}">
