<div wire:ignore.self id="modal"
    ...
    <div
        ...
        <div class="px-6 py-4 text-gray-600 space-y-4">
            <div>
                <label for="data_name" class="block text-sm font-medium text-gray-700">Nama Produk</label>
                <input type="text" id="data_name" wire:model="data_name" disabled
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <div>
                    <label for="price" class="block text-sm font-medium text-gray-700">Harga Jual Baru <span class="text-red-600">*</span></label>
                    <div class="mt-1 flex rounded-md shadow-sm">
                        ...
                        <input type="text" onkeyup="convertToRupiah(this);" id="price"
                            wire:model.live.debounce.400ms="price" placeholder="0" class="form-control rounded-l-none font-bold text-blue-700 text-sm" />
                    </div>
                    @error('price')
                        <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                    @enderror
