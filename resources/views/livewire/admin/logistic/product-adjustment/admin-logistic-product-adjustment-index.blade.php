                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse ($products as $index => $product)
                        <tr wire:key="product-{{ $product->id }}" class="hover:bg-blue-50/30 transition-colors">
                            ...
                            <td class="py-4">
                                <div class="relative max-w-[170px]">
                                ...
                                <div class="mt-1 flex flex-col gap-0.5 text-[10px]">
                                    <span class="text-emerald-700 font-semibold">Netto: Rp @number($product->productPrice->hpp_average ?? 0)</span>
                                    @if (($product->productPrice->hpp_average_without_discount ?? 0) > 0)
                                        <span class="text-amber-800 font-medium">Bruto: Rp @number($product->productPrice->hpp_average_without_discount ?? $product->productPrice->hpp_average ?? 0)</span>
                                    @endif
                                </div>
                            </td>
                            <td class="py-4">
