<div>
    @include('livewire.admin.logistic.replace-product.admin-logistic-replace-product-modal')
    @include('livewire.admin.logistic.replace-product.admin-logistic-replace-product-update-stock-modal')
    <div class="mb-4">
        <div class="flex items-center justify-between">
            ...
            <div>
                <a href="{{ asset('import/product.xlsx') }}" download="template-produk.xlsx"
                ...
                <tbody>
                    @forelse ($products as $index => $product)
                        <tr>
                            ...
                            <td class="center">
                                <button wire:click="openUpdateStockModal('{{ $product->id }}')"
