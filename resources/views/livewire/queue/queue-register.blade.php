<div>
    ...
    <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            ...
            <div class="bg-white py-8 px-6 shadow-2xl sm:rounded-2xl sm:px-10 border border-gray-200 backdrop-blur-sm">
                ...
                <div class="mb-10">
                    ...
                    <div class="flex items-center justify-between relative px-1 sm:px-2">
                        ...
                        <div class="flex flex-col items-center group cursor-pointer min-w-0 flex-1">
                            <div id="step1-indicator"
                                class="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 {{ $step >= 2 ? 'bg-gradient-to-br from-blue-500 to-blue-700 text-white' : 'bg-gray-300 text-gray-500' }} rounded-full text-sm font-bold shadow-xl transform transition-all duration-300 group-hover:scale-110 group-hover:shadow-2xl border-2 sm:border-4 border-white">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4">
                            ...
                            <span id="step1-text"
                                class="mt-2 sm:mt-3 text-xs sm:text-sm font-bold {{ $step >= 2 ? 'text-blue-600' : 'text-gray-500' }} text-center leading-tight px-1">Pilih
                                Poli</span>
                        </div>
                        ...
                        <div class="flex flex-col items-center group cursor-pointer min-w-0 flex-1">
                            ...
                            <span id="step2-text"
                                class="mt-2 sm:mt-3 text-xs sm:text-sm font-semibold {{ $step >= 3 ? 'text-blue-600' : 'text-gray-500' }} text-center leading-tight px-1">Pilih
                                Dokter</span>
                        </div>
                    ...
                    @if ($step === 1)
                        ...
                        <div id="step2" class="step animate-fade-in">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                @foreach ($company_items as $key => $company_item)
                                    <label class="company-option cursor-pointer group"
                                        wire:key='company-{{ $company_item->id }}'>
                                        <input type="radio" wire:model.live="company"
                                            value="{{ $company_item?->id }}" class="sr-only">
                                        <div
                                            ...
                                            {{ $company === $company_item?->id ? 'border-blue-500 bg-blue-50' : 'border-gray-200' }}">
                                            ...
                                            <div class="flex items-center">
                                                <div class="font-semibold text-gray-900-lg">{{ $company_item?->name }}
                                                </div>
                                                {{-- <div class="text-sm text-gray-500 mt-1">{{ $poli_item['desc'] }}</div> --}}
                                            </div>
                                        </div>
                                    </label>
                                @endforeach
                    ...
                    @elseif ($step === 2)
                        ...
                        <div id="step2" class="step animate-fade-in">
                            ...
                            <div class="grid grid-cols-1 gap-4 mb-8">
                                @foreach ($poli_items as $poli_item)
                                    <label class="poli-option cursor-pointer group"
                                        wire:key='poli-{{ $poli_item->id }}'>
                                        <input type="radio" wire:model.live="poli" value="{{ $poli_item?->id }}"
                                            class="sr-only">
                                        <div
                                            ...
                                            {{ $poli === $poli_item?->id ? 'border-blue-500 bg-blue-50' : 'border-gray-200' }}">
                                            {{-- <div class="text-3xl mr-4 transition-transform duration-300">{{ $poli_item['emoji'] }}</div> --}}
                                            <div class="text-3xl mr-4 transition-transform duration-300">🩺</div>
                                            <div class="flex-1">
                                                <div class="font-semibold text-gray-900-lg">{{ $poli_item?->name }}
                                                </div>
                                                <div class="text-sm text-gray-500 mt-1">{{ $poli_item?->description }}
                                                </div>
                                            </div>
                                            <div
                                                class="text-blue-500 {{ $poli === $poli_item?->id ? 'opacity-100' : 'opacity-0' }} transition-opacity duration-300">
                        ...
                        <div id="step3" class="step animate-fade-in">
                            ...
                            <div id="doctor-list" class="space-y-4 mb-8">
                                ...
                                @foreach ($doctors as $doctor)
                                    ...
                                    <label
                                        class="block border rounded-lg p-4 transition-all duration-200 {{ $doctor?->id == $selected_doctor ? 'border-blue-500 bg-blue-50 ring-blue-500' : '' }}
                                            {{ $isFullyBooked
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-3">
                                                <input type="radio" name="doctor_id"
                                                    wire:model.live="selected_doctor" value="{{ $doctor?->id }}"
                                                ...
                                                <div>
                                                    <h4 class="font-medium text-gray-900 dark:text-white">
                                                        {{ $doctor->name }}</h4>
                                                    <p
                                                        class="text-sm {{ $isFullyBooked ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400' }}">
                                            ...
                                            {{-- <div class="text-right">
                                                ...
                                                <div class="w-16 bg-gray-200 dark:bg-gray-700 rounded-full h-2 mt-1">
                                                    <div class="{{ $isFullyBooked ? 'bg-red-500' : 'bg-green-500' }} h-2 rounded-full"
                                ...
                                <div class="mb-6">
                                    ...
                                    <div id="time-slots" class="grid grid-cols-2 gap-3">
                                        @foreach ($time_slots as $slot)
                                            ...
                                            <label
                                                class="border rounded-lg p-3 cursor-pointer transition-all duration-200 {{ $slot['id'] == $selected_time ? 'border-blue-500 bg-blue-50 ring-blue-500' : '' }}
                                                {{ $isFullyBooked
                                                    ? 'border-red-300 bg-red-50 dark:bg-red-900/20 dark:border-red-600 opacity-60 cursor-not-allowed'
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <span
                                                        class="text-xs {{ $isFullyBooked ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400' }}">
                                                    ...
                                                    <div class="flex items-center space-x-1">
                                                        ...
                                                        <div class="w-8 bg-gray-200 dark:bg-gray-700 rounded-full h-1">
                                                            <div class="{{ $isFullyBooked ? 'bg-red-500' : 'bg-green-500' }} h-1 rounded-full"
                        ...
                        <div id="step5" class="step animate-fade-in">
                            ...
                            @else
                                ...
                                <div id="patient-form-section" class="space-y-6 animate-fade-in">
                                    {{-- <div
                                        class="bg-gradient-to-r from-blue-50 to-indigo-50/20/20 border-2 border-blue-200 rounded-xl p-6 mb-6">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <p class="text-sm font-semibold text-blue-800"
                                                    id="patient-status-text">Data pasien ditemukan</p>
                                            </div>
                                        </div>
                                    </div> --}}
                                    ...
                                    <div class="bg-gradient-to-r from-purple-50 to-purple-50 rounded-xl p-6 space-y-6">
                                        ...
                                        <div>
                                            ...
                                            {{-- <input type="email" id="email" name="email" class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500-all duration-300 hover:border-purple-300" placeholder="user@gmail.com"> --}}
        ...
        <div class="mt-8 text-center">
            <a href="{{ route('queue') }}" class="text-blue-600 hover:text-blue-800-300 font-medium">
