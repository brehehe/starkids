                ...
                @if (auth()->user()->hasRole(['Super Admin', 'Resepsionis', 'Kasir', 'Perawat']))
                    ...
                    <div>
                        <a href="/user/consultation/satusehat"
                            class="group flex items-center px-4 py-3 text-sm font-medium rounded-lg {{ Request::is('user/consultation/satusehat*') ? 'bg-[#C3D4EC]/50 text-[#1E3A8A] active-menu' : 'text-gray-600 hover:bg-[#C3D4EC]/20 hover:text-[#1E3A8A]' }} transition-colors duration-200">
                            <div class="flex items-center gap-3">
                                <i
                                    class="fa-solid fa-cloud-arrow-up mr-2 text-lg {{ Request::is('user/consultation/satusehat*') ? 'text-[#1E3A8A]' : 'text-gray-400 group-hover:text-[#1E3A8A]' }}"></i>
